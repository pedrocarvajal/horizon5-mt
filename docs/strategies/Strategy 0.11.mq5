...
input string CustomComment = "Strategy_0_11";
...
input int EMAPeriod1 = 118;        //EMAPeriod1
input int ATRPeriod1 = 101;        //ATRPeriod1
input int ATRPeriod2 = 119;        //ATRPeriod2
input int EMAPeriod2 = 120;        //EMAPeriod2
input int Period1 = 16;        //Period1
input int EMAPeriod3 = 94;        //EMAPeriod3
input double ProfitTargetCoef1 = 3.8;        //ProfitTargetCoef1
input double StopLossCoef1 = 3;        //StopLossCoef1
input double ProfitTargetCoef2 = 3.4;        //ProfitTargetCoef2
...
#define EMA_3 5     //iMA(NULL,0, EMAPeriod3, 0, MODE_EMA, PRICE_CLOSE)
...
string sqStrategyName = "Strategy 0.11";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = indyCrossesBelow(EMA_1, "sqClose(NULL,0, 1)", 1, 0, 0, 0);

     ShortEntrySignal = ((indyCrossesAbove(ATR_1, ATR_2, 1, 1, 0, 0)
      &&   indyCrossesBelow(EMA_2, HIGHEST_1, 1, 1, 0, 0))
      &&   (NormalizeDouble((double) sqGetIndicatorValue(EMA_3, 0, 1), 6) > NormalizeDouble((double) sqClose(NULL,0, 1), 6)));
