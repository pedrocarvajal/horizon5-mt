...
input string CustomComment = "Strategy_0_163";
...
input int EMAPeriod1 = 170;        //EMAPeriod1
input int SMAPeriod1 = 14;        //SMAPeriod1
input int EMAPeriod2 = 134;        //EMAPeriod2
input int SMAPeriod2 = 17;        //SMAPeriod2
...
input double ProfitTargetCoef2 = 4.7;        //ProfitTargetCoef2
...
string sqStrategyName = "Strategy 0.163";
...
if (_sqIsBarOpen == true) {
     ...
     ShortEntrySignal = ((NormalizeDouble((double) sqGetIndicatorValue(SMA_1, 0, 1), 6) < NormalizeDouble((double) sqGetIndicatorValue(EMA_2, 0, 1), 6))
      &&   indyCrossesBelow(SMA_2, HIGHEST_1, 1, 1, 0, 0));
