...
input string CustomComment = "Strategy_0_492";
...
input int ADXPeriod1 = 40;        //ADXPeriod1
...
string sqStrategyName = "Strategy 0.492";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (sqIsFalling(ADX_1, 2, true, 1 + 1, 2));
