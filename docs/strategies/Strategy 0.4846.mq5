...
input string CustomComment = "Strategy_0_4846";
...
input int SMAPeriod1 = 84;        //SMAPeriod1
...
input double StopLossCoef2 = 4;        //StopLossCoef2
...
string sqStrategyName = "Strategy 0.4846";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (sqIsRising(SMA_1, 8, true, 1 + 1, 0));

     ShortEntrySignal = (sqIsRising(HIGHEST_1, 8, true, 1 + 1, 0));
