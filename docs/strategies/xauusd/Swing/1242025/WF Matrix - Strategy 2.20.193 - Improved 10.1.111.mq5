//+------------------------------------------------------------------+
//| WF Matrix - Strategy 2.20.193 - Improved 10.1.111 EA
//|
...
input string CustomComment = "WF_Matrix_Strategy_2_20_193_Im";
...
input int ATRPeriod1 = 8;        //ATRPeriod1
input int ATRPeriod2 = 14;        //ATRPeriod2
input int IndicatorCrsMAPrd1 = 10;        //IndicatorCrsMAPrd1
input int Period1 = 19;        //Period1
input double ProfitTargetCoef1 = 1;        //ProfitTargetCoef1
input double StopLoss1 = 245;        //StopLoss1
...
#define HIGHEST_1 2     //iCustom(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "SqHighest", Period1, PRICE_CLOSE)
...
string sqStrategyName = "WF Matrix - Strategy 2.20.193 - Improved 10.1.111";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (((NormalizeDouble((double) sqGetIndicatorValue(ATR_1, 0, 1), 6) < NormalizeDouble((double) sqGetIndicatorValue(ATR_2, 0, 1), 6))
      &&   (sqIndicatorCrossesAboveMA("sqDaily(NULL,0,\"High\", 1)",IndicatorCrsMAPrd1,2, 1)))
