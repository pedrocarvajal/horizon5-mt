//+------------------------------------------------------------------+
//| WF Matrix - Strategy 1.29.143 - Improved 2.1.134 EA
//|
...
input string CustomComment = "WF_Matrix_Strategy_1_29_143_Im";
...
input int IndicatorCrsMAPrd1 = 8;        //IndicatorCrsMAPrd1
...
#define PIVOTS_1 0     //iCustom(NULL,0, "SqPivots", 0, 0)
#define ATR_1 1     //iCustom(NULL, 0, "SqATR", 24)
...
string sqStrategyName = "WF Matrix - Strategy 1.29.143 - Improved 2.1.134";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = ((NormalizeDouble((double) sqDaily(NULL,0, "High", 1), 6) > NormalizeDouble((double) sqGetIndicatorValue(PIVOTS_1, 1, 1), 6))
      &&   (sqIndicatorCrossesBelowMA("sqDaily(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe),\"Close\", 1)",IndicatorCrsMAPrd1,1, 1)));
