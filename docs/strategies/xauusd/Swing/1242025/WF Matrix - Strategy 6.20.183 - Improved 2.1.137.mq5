//+------------------------------------------------------------------+
//| WF Matrix - Strategy 6.20.183 - Improved 2.1.137 EA
//|
...
input string CustomComment = "WF_Matrix_Strategy_6_20_183_Im";
...
#define PIVOTS_1 0     //iCustom(NULL,0, "SqPivots", 18, 0)
#define PIVOTS_2 1     //iCustom(NULL,0, "SqPivots", 6, 30)
#define ATR_1 2     //iCustom(NULL, 0, "SqATR", 24)
...
string sqStrategyName = "WF Matrix - Strategy 6.20.183 - Improved 2.1.137";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = ((NormalizeDouble((double) sqMonthly(NULL,0, "Low", 1), 6) > NormalizeDouble((double) sqGetIndicatorValue(PIVOTS_1, 6, 1), 6))
      &&   (NormalizeDouble((double) sqGetIndicatorValue(PIVOTS_2, 0, 1), 6) < NormalizeDouble((double) sqWeekly(NULL,0, "Low", 1), 6)));
...
bool initIndicators(){
   ...
   indicatorHandles[PIVOTS_1] = iCustom(NULL,0, "SqPivots", 18, 0);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[PIVOTS_2] = iCustom(NULL,0, "SqPivots", 6, 30);
