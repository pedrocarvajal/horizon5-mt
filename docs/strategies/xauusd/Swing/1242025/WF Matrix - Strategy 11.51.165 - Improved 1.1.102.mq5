//+------------------------------------------------------------------+
//| WF Matrix - Strategy 11.51.165 - Improved 1.1.102 EA
//|
...
input string CustomComment = "WF_Matrix_Strategy_11_51_165_I";
...
input int IndicatorMAPeriod1 = 19;        //IndicatorMAPeriod1
input int SMAPeriod1 = 7;        //SMAPeriod1
...
#define PIVOTS_1 0     //iCustom(NULL,0, "SqPivots", 6, 30)
#define PARABOLICSAR_1 1     //iCustom(NULL,0, "SqParabolicSAR", 0.02, 0.4)
...
string sqStrategyName = "WF Matrix - Strategy 11.51.165 - Improved 1.1.102";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (indyCrossesBelow(PIVOTS_1, PARABOLICSAR_1, 1, 1, 5, 0)
      &&   (sqIsIndicatorBelowMA("sqGetIndicatorValue(SMA_1, 0, 1)",IndicatorMAPeriod1,2, 1)));
...
bool initIndicators(){
   ...
   indicatorHandles[PIVOTS_1] = iCustom(NULL,0, "SqPivots", 6, 30);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[PARABOLICSAR_1] = iCustom(NULL,0, "SqParabolicSAR", 0.02, 0.4);
