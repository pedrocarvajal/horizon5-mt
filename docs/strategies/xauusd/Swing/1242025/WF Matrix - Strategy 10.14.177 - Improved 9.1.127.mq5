//+------------------------------------------------------------------+
//| WF Matrix - Strategy 10.14.177 - Improved 9.1.127 EA
//|
...
input string CustomComment = "WF_Matrix_Strategy_10_14_177_I";
...
#define PARABOLICSAR_1 0     //iCustom(NULL,0, "SqParabolicSAR", 0.01, 0.2)
...
string sqStrategyName = "WF Matrix - Strategy 10.14.177 - Improved 9.1.127";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = ((NormalizeDouble((double) sqMonthly(NULL,0, "High", 1), 6) > NormalizeDouble((double) sqGetIndicatorValue(PARABOLICSAR_1, 0, 1), 6))
      &&   (sqIndicatorCrossesBelowMA("sqWeekly(NULL,0,\"High\", 1)",IndicatorCrsMAPrd1,1, 1)));
