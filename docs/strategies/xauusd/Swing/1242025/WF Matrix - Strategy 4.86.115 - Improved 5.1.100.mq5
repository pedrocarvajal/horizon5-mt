//+------------------------------------------------------------------+
//| WF Matrix - Strategy 4.86.115 - Improved 5.1.100 EA
//|
...
input string CustomComment = "WF_Matrix_Strategy_4_86_115_Im";
...
input int EMAPeriod1 = 23;        //EMAPeriod1
...
string sqStrategyName = "WF Matrix - Strategy 4.86.115 - Improved 5.1.100";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (indyCrossesBelow(ATR_1, ATR_2, 1, 1, 0, 0)
      &&   (NormalizeDouble((double) sqGetIndicatorValue(EMA_1, 0, 1), 6) < NormalizeDouble((double) sqWeekly(NULL,0, "Low", 1), 6)));
