//+------------------------------------------------------------------+
//| WF Matrix - Strategy 10.6.125 - Improved 2.1.106 EA
//|
...
input string CustomComment = "WF_Matrix_Strategy_10_6_125_Im";
...
input int IndicatorCrsMAPrd1 = 5;        //IndicatorCrsMAPrd1
input double ProfitTargetCoef1 = 1;        //ProfitTargetCoef1
input double StopLoss1 = 3.2;        //StopLoss1
...
string sqStrategyName = "WF Matrix - Strategy 10.6.125 - Improved 2.1.106";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (sqIndicatorCrossesBelowMA("sqWeekly(NULL,0,\"Low\", 1)",IndicatorCrsMAPrd1,1, 1));
