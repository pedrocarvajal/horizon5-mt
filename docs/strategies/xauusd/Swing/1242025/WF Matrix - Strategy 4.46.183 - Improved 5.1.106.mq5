//+------------------------------------------------------------------+
//| WF Matrix - Strategy 4.46.183 - Improved 5.1.106 EA
//|
...
input string CustomComment = "WF_Matrix_Strategy_4_46_183_Im";
...
input int MomentumPeriod1 = 14;        //MomentumPeriod1
input int MomentumPeriod2 = 13;        //MomentumPeriod2
input int EMAPeriod1 = 15;        //EMAPeriod1
input double ProfitTargetCoef1 = 1;        //ProfitTargetCoef1
input double StopLoss1 = 1.2;        //StopLoss1
...
#define MOMENTUM_1 0     //iMomentum(NULL,0, MomentumPeriod1, PRICE_CLOSE)
#define MOMENTUM_2 1     //iMomentum(NULL,0, MomentumPeriod2, PRICE_CLOSE)
...
string sqStrategyName = "WF Matrix - Strategy 4.46.183 - Improved 5.1.106";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = ((NormalizeDouble((double) sqGetIndicatorValue(MOMENTUM_1, 0, 1), 6) > NormalizeDouble((double) sqGetIndicatorValue(MOMENTUM_2, 0, 1), 6))
      &&   indyCrossesBelow(EMA_1, "sqDaily(NULL,0,\"High\", 1)", 1, 0, 0, 0));
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[MOMENTUM_2] = iMomentum(NULL,0, MomentumPeriod2, PRICE_CLOSE);
