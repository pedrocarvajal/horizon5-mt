//+------------------------------------------------------------------+
//| WF Matrix - Strategy 4.5.128 - Improved 7.1.129 EA
//|
//|    Generated by StrategyQuant X Build 143 for MetaTrader5 (hedged)
//|    Generated at 01/28/2026 05:21
//| 
//|    Backtested on XAUUSD_darwinex / H1,D1, 2017.10.02 - 2026.01.01 
//+------------------------------------------------------------------+
...
input string CustomComment = "WF_Matrix_Strategy_4_5_128_Imp";
...
input int ATRPeriod1 = 12;        //ATRPeriod1
input int ATRPeriod2 = 14;        //ATRPeriod2
input int SMAPeriod1 = 25;        //SMAPeriod1
input double ProfitTargetCoef1 = 1;        //ProfitTargetCoef1
input double StopLoss1 = 3.8;        //StopLoss1
...
input string FridayCloseTime = "00:00";
...
input int MinimumPT = 30;   //Minimum PT in pips
...
#define PARABOLICSAR_1 2     //iCustom(NULL,0, "SqParabolicSAR", 0.01, 0.2)
#define SMA_1 3     //iMA(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), SMAPeriod1, 0, MODE_SMA, PRICE_CLOSE)
#define ATR_3 4     //iCustom(NULL, 0, "SqATR", 24)
...
string sqStrategyName = "WF Matrix - Strategy 4.5.128 - Improved 7.1.129";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (((NormalizeDouble((double) sqGetIndicatorValue(ATR_1, 0, 1), 6) < NormalizeDouble((double) sqGetIndicatorValue(ATR_2, 0, 1), 6))
      &&   indyCrossesAbove("sqDaily(NULL,0,\"High\", 1)", "sqClose(NULL,0, 1)", 0, 0, 0, 0))
      &&   (NormalizeDouble((double) sqGetIndicatorValue(PARABOLICSAR_1, 0, 1), 6) < NormalizeDouble((double) sqGetIndicatorValue(SMA_1, 0, 1), 6)));
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[PARABOLICSAR_1] = iCustom(NULL,0, "SqParabolicSAR", 0.01, 0.2);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[SMA_1] = iMA(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), SMAPeriod1, 0, MODE_SMA, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_3] = iCustom(NULL, 0, "SqATR", 24);
...
double sqGetExpressionByIdentification(string id, int shift) {
      if(id == "sqDaily(NULL,0,\"High\", 1)") {
          return   sqDaily(NULL,0, "High", shift + 1);
      }
