//+------------------------------------------------------------------+
//| WF Matrix - Strategy 3.29.99 - Improved 6.1.134 EA
//|
...
input string CustomComment = "WF_Matrix_Strategy_3_29_99_Imp";
...
input int ATRPeriod1 = 13;        //ATRPeriod1
input int ATRPeriod2 = 12;        //ATRPeriod2
input int IndicatorMAPeriod1 = 6;        //IndicatorMAPeriod1
input int EMAPeriod1 = 36;        //EMAPeriod1
input double ProfitTargetCoef1 = 1;        //ProfitTargetCoef1
input double StopLoss1 = 0.9;        //StopLoss1
...
#define EMA_1 2     //iMA(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), EMAPeriod1, 0, MODE_EMA, PRICE_CLOSE)
#define ATR_3 3     //iCustom(NULL, 0, "SqATR", 24)
...
string sqStrategyName = "WF Matrix - Strategy 3.29.99 - Improved 6.1.134";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (((NormalizeDouble((double) sqGetIndicatorValue(ATR_1, 0, 1), 6) > NormalizeDouble((double) sqGetIndicatorValue(ATR_2, 0, 1), 6))
      &&   (sqIsIndicatorAboveMA("sqDaily(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe),\"Close\", 1)",IndicatorMAPeriod1,1, 1)))
      &&   (NormalizeDouble((double) sqDaily(NULL,0, "Close", 1), 6) < NormalizeDouble((double) sqGetIndicatorValue(EMA_1, 0, 1), 6)));
...
double sqGetExpressionByIdentification(string id, int shift) {
      if(id == "sqDaily(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe),\"Close\", 1)") {
          return   sqDaily(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "Close", shift + 1);
      }
