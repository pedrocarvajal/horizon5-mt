//+------------------------------------------------------------------+
//| WF Matrix - Strategy 12.48.108 - Improved 10.1.107 EA
//|
...
input string CustomComment = "WF_Matrix_Strategy_12_48_108_I";
...
#define PIVOTS_1 0     //iCustom(NULL,0, "SqPivots", 12, 0)
...
string sqStrategyName = "WF Matrix - Strategy 12.48.108 - Improved 10.1.107";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = ((NormalizeDouble((double) sqWeekly(NULL,0, "Low", 1), 6) < NormalizeDouble((double) sqGetIndicatorValue(PIVOTS_1, 5, 1), 6))
      &&   (sqIsIndicatorBelowMA("sqDaily(NULL,0,\"Close\", 1)",IndicatorMAPeriod1,1, 1)));
