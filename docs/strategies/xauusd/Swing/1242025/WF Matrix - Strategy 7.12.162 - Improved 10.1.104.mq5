//+------------------------------------------------------------------+
//| WF Matrix - Strategy 7.12.162 - Improved 10.1.104 EA
//|
...
input string CustomComment = "WF_Matrix_Strategy_7_12_162_Im";
...
input int EMAPeriod1 = 8;        //EMAPeriod1
input double ProfitTargetCoef1 = 1;        //ProfitTargetCoef1
input double StopLoss1 = 3.4;        //StopLoss1
...
#define PIVOTS_1 1     //iCustom(NULL,0, "SqPivots", 6, 0)
...
string sqStrategyName = "WF Matrix - Strategy 7.12.162 - Improved 10.1.104";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (NormalizeDouble((double) sqGetIndicatorValue(EMA_1, 0, 1), 6) > NormalizeDouble((double) sqGetIndicatorValue(PIVOTS_1, 2, 1), 6));
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[PIVOTS_1] = iCustom(NULL,0, "SqPivots", 6, 0);
