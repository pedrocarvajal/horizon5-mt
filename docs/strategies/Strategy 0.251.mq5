...
input string CustomComment = "Strategy_0_251";
...
input int EMAPeriod1 = 182;        //EMAPeriod1
input int EMAPeriod2 = 171;        //EMAPeriod2
input int SMAPeriod1 = 45;        //SMAPeriod1
...
input double ProfitTargetCoef2 = 2.4;        //ProfitTargetCoef2
...
string sqStrategyName = "Strategy 0.251";
...
if (_sqIsBarOpen == true) {
     ...
     ShortEntrySignal = ((NormalizeDouble((double) sqGetIndicatorValue(SMA_1, 0, 1), 6) > NormalizeDouble((double) sqGetIndicatorValue(HIGHEST_1, 0, 1), 6))
      &&   indyCrossesBelow("sqClose(NULL,0, 1)", HIGHEST_2, 0, 1, 0, 0));
