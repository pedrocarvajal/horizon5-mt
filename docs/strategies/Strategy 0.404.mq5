...
input string CustomComment = "Strategy_0_404";
...
string sqStrategyName = "Strategy 0.404";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (NormalizeDouble((double) sqGetIndicatorValue(LOWEST_1, 0, 1), 6) < NormalizeDouble((double) sqClose(NULL,0, 1), 6));

     ShortEntrySignal = (sqIsFalling("sqClose(NULL,0, 1)", 4, false, 0 + 1, 0));
