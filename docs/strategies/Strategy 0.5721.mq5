...
input string CustomComment = "Strategy_0_5721";
...
input int EMAPeriod1 = 7;        //EMAPeriod1
input int Period1 = 21;        //Period1
input int SMAPeriod1 = 154;        //SMAPeriod1
...
input double StopLossCoef2 = 4.5;        //StopLossCoef2
...
string sqStrategyName = "Strategy 0.5721";
...
if (_sqIsBarOpen == true) {
     ...
     ShortEntrySignal = (sqIsFalling(SMA_1, 11, true, 1 + 1, 0));
