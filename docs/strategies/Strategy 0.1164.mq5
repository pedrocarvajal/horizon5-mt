...
input string CustomComment = "Strategy_0_1164";
...
input int ATRPeriod1 = 139;        //ATRPeriod1
input int ATRPeriod2 = 121;        //ATRPeriod2
input int Period1 = 1;        //Period1
input int SMAPeriod1 = 180;        //SMAPeriod1
...
input double StopLossCoef2 = 4.4;        //StopLossCoef2
...
#define LOWEST_1 4     //iCustom(NULL,0, "SqLowest", Period2, PRICE_CLOSE)
...
string sqStrategyName = "Strategy 0.1164";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = ((NormalizeDouble((double) sqGetIndicatorValue(ATR_1, 0, 1), 6) < NormalizeDouble((double) sqGetIndicatorValue(ATR_2, 0, 1), 6))
      &&   indyCrossesBelow(HIGHEST_1, SMA_1, 1, 1, 0, 0));

     ShortEntrySignal = indyCrossesBelow(LOWEST_1, "sqClose(NULL,0, 1)", 1, 0, 0, 0);
