...
input string CustomComment = "Strategy_0_2165";
...
string sqStrategyName = "Strategy 0.2165";
...
if (_sqIsBarOpen == true) {
     ...
     ShortEntrySignal = ((sqIsFalling("sqClose(NULL,0, 1)", 7, false, 0 + 1, 0))
      &&   indyCrossesBelow(HIGHEST_1, LOWEST_2, 1, 1, 0, 0));
