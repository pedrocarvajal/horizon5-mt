...
input string CustomComment = "Strategy_0_5155";
...
input int SMAPeriod2 = 151;        //SMAPeriod2
...
input double StopLossCoef2 = 4.1;        //StopLossCoef2
...
string sqStrategyName = "Strategy 0.5155";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (NormalizeDouble((double) sqGetIndicatorValue(SMA_1, 0, 1), 6) < NormalizeDouble((double) sqGetIndicatorValue(EMA_1, 0, 1), 6));

     ShortEntrySignal = (sqIsRising(SMA_2, 10, false, 1 + 1, 0));
