...
input string CustomComment = "Strategy_0_7633";
...
input int SMAPeriod1 = 149;        //SMAPeriod1
input int ATRPeriod1 = 90;        //ATRPeriod1
input int ATRPeriod2 = 113;        //ATRPeriod2
input int ATRPeriod3 = 22;        //ATRPeriod3
input double ProfitTargetCoef1 = 4.4;        //ProfitTargetCoef1
input double StopLossCoef1 = 3.3;        //StopLossCoef1
input double ProfitTargetCoef2 = 3;        //ProfitTargetCoef2
...
#define PARABOLICSAR_1 2     //iCustom(NULL,0, "SqParabolicSAR", 0.04, 0.2)
#define PIVOTS_1 3     //iCustom(NULL,0, "SqPivots", 12, 0)
#define ATR_1 4     //iCustom(NULL,0, "SqATR", ATRPeriod1)
#define ATR_2 5     //iCustom(NULL,0, "SqATR", ATRPeriod2)
#define ATR_3 6     //iCustom(NULL,0, "SqATR", ATRPeriod3)
#define ATR_4 7     //iCustom(NULL, 0, "SqATR", 14)
...
string sqStrategyName = "Strategy 0.7633";
...
if (_sqIsBarOpen == true) {
     ...
     ShortEntrySignal = (((NormalizeDouble((double) sqGetIndicatorValue(PARABOLICSAR_1, 0, 1), 6) < NormalizeDouble((double) sqGetIndicatorValue(PIVOTS_1, 4, 1), 6))
      &&   (sqIsRising(ATR_1, 3, true, 1 + 1, 0)))
      &&   (NormalizeDouble((double) sqGetIndicatorValue(ATR_2, 0, 1), 6) < NormalizeDouble((double) sqGetIndicatorValue(ATR_3, 0, 1), 6)));
...
//------------------------
...
)
   {
      ...
      sl = sqFixMarketPrice(sqGetSLLevel("Current", ORDER_TYPE_SELL, openPrice, 2, StopLossCoef2 * sqGetIndicatorValue(ATR_4, 1)), "Current");
      pt = sqFixMarketPrice(sqGetPTLevel("Current", ORDER_TYPE_SELL, openPrice, 2, ProfitTargetCoef2 * sqGetIndicatorValue(ATR_4, 1)), "Current");
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[PIVOTS_1] = iCustom(NULL,0, "SqPivots", 12, 0);
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_4] = iCustom(NULL, 0, "SqATR", 14);
