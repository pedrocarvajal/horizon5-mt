...
//|    Generated at 02/08/2026 06:48
//| 
//|    Backtested on XAUUSD_dukascopy / H1, 2023.02.01 - 2026.02.01 
//+------------------------------------------------------------------+
...
input string CustomComment = "Strategy_0_6818";
...
input int SMAPeriod1 = 156;        //SMAPeriod1
input int Period1 = 6;        //Period1
input int ADXPeriod1 = 98;        //ADXPeriod1
input int ADXPeriod2 = 115;        //ADXPeriod2
input int Period2 = 16;        //Period2
input double ProfitTargetCoef1 = 3.9;        //ProfitTargetCoef1
...
#define ADX_1 2     //iCustom(NULL,0, "SqADX", ADXPeriod1)
#define ADX_2 3     //iCustom(NULL,0, "SqADX", ADXPeriod2)
#define PARABOLICSAR_1 4     //iCustom(NULL,0, "SqParabolicSAR", 0.02, 0.3)
#define HIGHEST_1 5     //iCustom(NULL,0, "SqHighest", Period2, PRICE_CLOSE)
#define ATR_1 6     //iCustom(NULL, 0, "SqATR", 14)
...
string sqStrategyName = "Strategy 0.6818";
...
if (_sqIsBarOpen == true) {
     ...
     ShortEntrySignal = (((sqIsRising("sqClose(NULL,0, 1)", 4, true, 0 + 1, 0))
      &&   (NormalizeDouble((double) sqGetIndicatorValue(ADX_1, 1, 1), 6) < NormalizeDouble((double) sqGetIndicatorValue(ADX_2, 0, 1), 6)))
      &&   indyCrossesAbove(PARABOLICSAR_1, HIGHEST_1, 1, 1, 0, 0));
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ADX_1] = iCustom(NULL,0, "SqADX", ADXPeriod1);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ADX_2] = iCustom(NULL,0, "SqADX", ADXPeriod2);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[PARABOLICSAR_1] = iCustom(NULL,0, "SqParabolicSAR", 0.02, 0.3);
