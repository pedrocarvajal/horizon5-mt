...
input string CustomComment = "Strategy_0_4388";
...
input int SMAPeriod1 = 173;        //SMAPeriod1
input double ProfitTargetCoef1 = 4.6;        //ProfitTargetCoef1
input double StopLossCoef1 = 3.8;        //StopLossCoef1
...
string sqStrategyName = "Strategy 0.4388";
...
if (_sqIsBarOpen == true) {
     ...
     ShortEntrySignal = ((indyCrossesBelow(PARABOLICSAR_1, "sqClose(NULL,0, 1)", 1, 0, 0, 0)
      &&   (sqIsFalling("sqClose(NULL,0, 1)", 3, true, 0 + 1, 0)))
      &&   (sqIsFalling("sqClose(NULL,0, 1)", 4, false, 0 + 1, 0)));
