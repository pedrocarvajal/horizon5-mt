...
input string CustomComment = "Strategy_0_13723";
...
input double ProfitTargetCoef2 = 1.4;        //ProfitTargetCoef2
...
#define PIVOTS_1 1     //iCustom(NULL,0, "SqPivots", 0, 30)
...
string sqStrategyName = "Strategy 0.13723";
...
if (_sqIsBarOpen == true) {
     ...
     ShortEntrySignal = indyCrossesAbove(PIVOTS_1, LOWEST_1, 1, 1, 3, 0);
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[PIVOTS_1] = iCustom(NULL,0, "SqPivots", 0, 30);
