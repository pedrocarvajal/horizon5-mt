...
input string CustomComment = "Strategy_0_5917";
...
input int SMAPeriod1 = 129;        //SMAPeriod1
input int ATRPeriod1 = 75;        //ATRPeriod1
input int ATRPeriod2 = 74;        //ATRPeriod2
input int SMAPeriod2 = 110;        //SMAPeriod2
input double ProfitTargetCoef1 = 2.3;        //ProfitTargetCoef1
input double StopLossCoef1 = 3.2;        //StopLossCoef1
input double ProfitTargetCoef2 = 3.7;        //ProfitTargetCoef2
...
#define ATR_3 4     //iCustom(NULL, 0, "SqATR", 14)
...
string sqStrategyName = "Strategy 0.5917";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (sqIsRising(SMA_1, 2, true, 1 + 1, 0));
