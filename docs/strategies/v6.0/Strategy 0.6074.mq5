...
input string CustomComment = "Strategy_0_6074";
...
input int SMAPeriod1 = 190;        //SMAPeriod1
input int Period1 = 21;        //Period1
input int ATRPeriod1 = 180;        //ATRPeriod1
...
input double StopLossCoef2 = 5;        //StopLossCoef2
...
#define PIVOTS_1 4     //iCustom(NULL,0, "SqPivots", 12, 30)
#define PARABOLICSAR_1 5     //iCustom(NULL,0, "SqParabolicSAR", 0.02, 0.3)
#define ATR_3 6     //iCustom(NULL, 0, "SqATR", 14)
...
string sqStrategyName = "Strategy 0.6074";
...
if (_sqIsBarOpen == true) {
     ...
     ShortEntrySignal = (((sqIsRising(ATR_1, 2, false, 1 + 1, 0))
      &&   (sqIsFalling(ATR_2, 3, true, 1 + 1, 0)))
      &&   indyCrossesAbove(PIVOTS_1, PARABOLICSAR_1, 1, 1, 0, 0));
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[PIVOTS_1] = iCustom(NULL,0, "SqPivots", 12, 30);
