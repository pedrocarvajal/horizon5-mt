...
input string CustomComment = "Strategy_0_237";
...
input int ATRPeriod1 = 131;        //ATRPeriod1
...
#define PARABOLICSAR_1 0     //iCustom(NULL,0, "SqParabolicSAR", 0.01, 0.3)
...
string sqStrategyName = "Strategy 0.237";
...
if (_sqIsBarOpen == true) {
     ...
     ShortEntrySignal = ((sqIsRising(PARABOLICSAR_1, 2, false, 1 + 1, 0))
...
bool initIndicators(){
   ...
   indicatorHandles[PARABOLICSAR_1] = iCustom(NULL,0, "SqParabolicSAR", 0.01, 0.3);
