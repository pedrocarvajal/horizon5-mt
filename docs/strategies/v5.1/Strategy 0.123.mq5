...
input string CustomComment = "Strategy_0_123";
...
input int ADXPeriod1 = 68;        //ADXPeriod1
input double ProfitTargetCoef1 = 1.5;        //ProfitTargetCoef1
...
string sqStrategyName = "Strategy 0.123";
...
if (_sqIsBarOpen == true) {
     ...
     ShortEntrySignal = ((sqIsFalling(HIGHEST_1, 4, false, 1 + 1, 0))
      &&   (NormalizeDouble((double) sqGetIndicatorValue(ADX_1, 0, 1), 6) > NormalizeDouble((double) 60.0, 6)));
