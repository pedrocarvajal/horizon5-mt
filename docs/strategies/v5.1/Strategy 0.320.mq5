...
input string CustomComment = "Strategy_0_320";
...
input int ATRPeriod1 = 126;        //ATRPeriod1
input int ATRPeriod2 = 56;        //ATRPeriod2
input double ProfitTargetCoef1 = 1.7;        //ProfitTargetCoef1
input double StopLossCoef1 = 3.2;        //StopLossCoef1
input double ProfitTargetCoef2 = 4.1;        //ProfitTargetCoef2
...
#define ATR_3 2     //iCustom(NULL, 0, "SqATR", 14)
...
string sqStrategyName = "Strategy 0.320";
...
if (_sqIsBarOpen == true) {
     ...
     ShortEntrySignal = (sqIsLowerCount("sqGetIndicatorValue(ATR_1, 0, 1)","sqGetIndicatorValue(ATR_2, 0, 1)",6,true,1));
...
double sqGetExpressionByIdentification(string id, int shift) {
      if(id == "sqGetIndicatorValue(ATR_1, 0, 1)") {
          return sqGetIndicatorValue(ATR_1, 0, shift + 1);
      }
      if(id == "sqGetIndicatorValue(ATR_2, 0, 1)") {
          return sqGetIndicatorValue(ATR_2, 0, shift + 1);
      }
