...
input string CustomComment = "Strategy_0_851";
...
#define ATR_1 1     //iCustom(NULL, 0, "SqATR", 14)
...
string sqStrategyName = "Strategy 0.851";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (NormalizeDouble((double) sqWeekly(NULL,0, "Open", 1), 6) < NormalizeDouble((double) sqGetIndicatorValue(LOWEST_1, 0, 1), 6));

     ShortEntrySignal = (sqIsGreaterCount("sqClose(NULL,0, 1)","sqClose(NULL,0, 1)",2,false,1));
