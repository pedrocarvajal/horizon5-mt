...
input string CustomComment = "Strategy_0_992";
...
input int SMAPeriod1 = 178;        //SMAPeriod1
input int ADXPeriod1 = 57;        //ADXPeriod1
input int ADXPeriod2 = 39;        //ADXPeriod2
input int ADXPeriod3 = 142;        //ADXPeriod3
input double ProfitTargetCoef1 = 2.6;        //ProfitTargetCoef1
input double StopLossCoef1 = 4.5;        //StopLossCoef1
input double ProfitTargetCoef2 = 3.8;        //ProfitTargetCoef2
...
#define ADX_2 2     //iCustom(NULL,0, "SqADX", ADXPeriod2)
#define ADX_3 3     //iCustom(NULL,0, "SqADX", ADXPeriod3)
...
string sqStrategyName = "Strategy 0.992";
...
if (_sqIsBarOpen == true) {
     ...
     ShortEntrySignal = ((NormalizeDouble((double) sqGetIndicatorValue(ADX_1, 2, 1), 6) < NormalizeDouble((double) sqGetIndicatorValue(ADX_2, 0, 1), 6))
      &&   indyCrossesBelow(ADX_3, "20.0", 1, 0, 2, 0));
