...
input string CustomComment = "Strategy_0_527";
...
input int ATRPeriod1 = 153;        //ATRPeriod1
...
input double ProfitTargetCoef2 = 3.3;        //ProfitTargetCoef2
...
#define PIVOTS_1 1     //iCustom(NULL,0, "SqPivots", 6, 30)
...
string sqStrategyName = "Strategy 0.527";
...
if (_sqIsBarOpen == true) {
     ...
     ShortEntrySignal = ((sqIsRising(ATR_1, 3, false, 1 + 1, 0))
      &&   indyCrossesBelow(PIVOTS_1, LOWEST_1, 1, 1, 2, 0));
