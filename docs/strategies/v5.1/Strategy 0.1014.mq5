...
//|    Generated at 02/06/2026 10:50
//| 
//|    Backtested on XAUUSD_darwinex_local / H1, 2021.01.01 - 2026.01.01 
//+------------------------------------------------------------------+
...
input string CustomComment = "Strategy_0_1014";
...
input int ADXPeriod1 = 194;        //ADXPeriod1
input int ADXPeriod2 = 52;        //ADXPeriod2
input int SMAPeriod1 = 105;        //SMAPeriod1
input int Period1 = 1;        //Period1
input double ProfitTargetCoef1 = 5;        //ProfitTargetCoef1
input double StopLossCoef1 = 2.3;        //StopLossCoef1
input double ProfitTargetCoef2 = 4.2;        //ProfitTargetCoef2
input double StopLossCoef2 = 4.7;        //StopLossCoef2
...
#define ATR_1 4     //iCustom(NULL, 0, "SqATR", 14)
...
string sqStrategyName = "Strategy 0.1014";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = ((sqIsGreaterCount("sqGetIndicatorValue(ADX_1, 1, 1)","sqGetIndicatorValue(ADX_2, 0, 1)",10,true,1))
      &&   (sqIsRising(SMA_1, 3, true, 1 + 1, 0)));

     ShortEntrySignal = (NormalizeDouble((double) sqGetIndicatorValue(HIGHEST_1, 0, 1), 6) < NormalizeDouble((double) sqClose(NULL,0, 1), 6));
...
double sqGetExpressionByIdentification(string id, int shift) {
      if(id == "sqGetIndicatorValue(ADX_1, 1, 1)") {
          return sqGetIndicatorValue(ADX_1, 1, shift + 1);
      }
