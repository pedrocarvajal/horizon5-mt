...
input string CustomComment = "Strategy_0_915";
...
input int ATRPeriod1 = 54;        //ATRPeriod1
input int ATRPeriod2 = 57;        //ATRPeriod2
...
string sqStrategyName = "Strategy 0.915";
...
if (_sqIsBarOpen == true) {
     ...
     ShortEntrySignal = (((NormalizeDouble((double) sqDaily(NULL,0, "High", 1), 6) < NormalizeDouble((double) sqMonthly(NULL,0, "High", 1), 6))
      &&   indyCrossesBelow("sqMonthly(NULL,0,\"Low\", 1)", "sqClose(NULL,0, 1)", 0, 0, 0, 0))
      &&   (sqIsFalling("sqDaily(NULL,0,\"High\", 1)", 2, false, 0 + 1, 0)));
...
double sqGetExpressionByIdentification(string id, int shift) {
      if(id == "sqMonthly(NULL,0,\"Low\", 1)") {
          return   sqMonthly(NULL,0, "Low", shift + 1);
      }
