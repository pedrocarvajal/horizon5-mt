...
input string CustomComment = "Strategy_0_334";
...
input int ADXPeriod1 = 123;        //ADXPeriod1
input int ATRPeriod1 = 24;        //ATRPeriod1
input double ProfitTargetCoef1 = 2.3;        //ProfitTargetCoef1
input double StopLossCoef1 = 2;        //StopLossCoef1
input double ProfitTargetCoef2 = 1.8;        //ProfitTargetCoef2
input double StopLossCoef2 = 2.1;        //StopLossCoef2
...
#define ATR_2 2     //iCustom(NULL, 0, "SqATR", 14)
...
string sqStrategyName = "Strategy 0.334";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (sqIsRising(ADX_1, 4, false, 1 + 1, 0));

     ShortEntrySignal = (((sqIsFalling("sqClose(NULL,0, 1)", 4, true, 0 + 1, 0))
      &&   indyCrossesBelow("sqDaily(NULL,0,\"Close\", 1)", "sqWeekly(NULL,0,\"Open\", 1)", 0, 0, 0, 0))
      &&   (sqIsRising(ATR_1, 2, true, 1 + 1, 0)));
...
double sqGetExpressionByIdentification(string id, int shift) {
      ...
      if(id == "sqDaily(NULL,0,\"Close\", 1)") {
          return   sqDaily(NULL,0, "Close", shift + 1);
      }
