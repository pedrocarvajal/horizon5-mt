...
input string CustomComment = "Strategy_0_480";
...
#define PIVOTS_2 3     //iCustom(NULL,0, "SqPivots", 6, 0)
...
string sqStrategyName = "Strategy 0.480";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (((sqIsGreaterCount("sqGetIndicatorValue(HIGHEST_1, 0, 1)","sqGetIndicatorValue(PIVOTS_1, 0, 1)",4,false,1))
      &&   indyCrossesBelow("sqWeekly(NULL,0,\"Open\", 1)", LOWEST_1, 0, 1, 0, 0))
      &&   (sqIsRising("sqMonthly(NULL,0,\"High\", 1)", 2, false, 0 + 1, 0)));

     ShortEntrySignal = (indyCrossesAbove("sqWeekly(NULL,0,\"Open\", 1)", PIVOTS_2, 0, 1, 0, 4)
      &&   (sqIsFalling(SMA_1, 3, false, 1 + 1, 0)));
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[PIVOTS_2] = iCustom(NULL,0, "SqPivots", 6, 0);
...
double sqGetExpressionByIdentification(string id, int shift) {
      ...
      if(id == "sqGetIndicatorValue(PIVOTS_1, 0, 1)") {
          return sqGetIndicatorValue(PIVOTS_1, 0, shift + 1);
      }
      if(id == "sqWeekly(NULL,0,\"Open\", 1)") {
          return   sqWeekly(NULL,0, "Open", shift + 1);
      }
      if(id == "sqMonthly(NULL,0,\"High\", 1)") {
          return   sqMonthly(NULL,0, "High", shift + 1);
      }
