...
input string CustomComment = "Strategy_0_178";
...
input int SMAPeriod1 = 136;        //SMAPeriod1
input int ATRPeriod1 = 60;        //ATRPeriod1
input int ATRPeriod2 = 125;        //ATRPeriod2
...
input double StopLossCoef2 = 2.8;        //StopLossCoef2
...
#define ATR_3 3     //iCustom(NULL, 0, "SqATR", 14)
...
string sqStrategyName = "Strategy 0.178";
...
if (_sqIsBarOpen == true) {
     ...
     ShortEntrySignal = ((sqIsFalling(SMA_1, 4, true, 1 + 1, 0))
      &&   indyCrossesAbove(ATR_1, ATR_2, 1, 1, 0, 0));
