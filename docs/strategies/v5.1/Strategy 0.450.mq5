...
input string CustomComment = "Strategy_0_450";
...
string sqStrategyName = "Strategy 0.450";
...
if (_sqIsBarOpen == true) {
     ...
     ShortEntrySignal = (sqIsLowerCount("sqGetIndicatorValue(SMA_1, 0, 1)","sqGetIndicatorValue(LOWEST_1, 0, 1)",4,false,1));
...
double sqGetExpressionByIdentification(string id, int shift) {
      ...
      if(id == "sqGetIndicatorValue(LOWEST_1, 0, 1)") {
          return sqGetIndicatorValue(LOWEST_1, 0, shift + 1);
      }
