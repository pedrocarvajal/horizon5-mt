...
input int SMAPeriod1 = 165;        //SMAPeriod1
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (NormalizeDouble((double) sqWeekly(NULL,0, "Open", 1), 6) < NormalizeDouble((double) sqDaily(NULL,0, "Low", 1), 6));

     ShortEntrySignal = (((sqIsRising("sqMonthly(NULL,0,\"High\", 1)", 3, true, 0 + 1, 0))
      &&   (sqIsLowerCount("sqMonthly(NULL,0,\"Close\", 1)","sqGetIndicatorValue(HIGHEST_1, 0, 1)",8,true,1)))
      &&   (NormalizeDouble((double) sqGetIndicatorValue(SMA_1, 0, 1), 6) > NormalizeDouble((double) sqMonthly(NULL,0, "Close", 1), 6)));
...
double sqGetExpressionByIdentification(string id, int shift) {
      ...
      if(id == "sqMonthly(NULL,0,\"Close\", 1)") {
          return   sqMonthly(NULL,0, "Close", shift + 1);
      }
