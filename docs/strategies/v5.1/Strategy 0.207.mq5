...
input string CustomComment = "Strategy_0_207";
...
input int SMAPeriod1 = 151;        //SMAPeriod1
input int ADXPeriod1 = 67;        //ADXPeriod1
input double ProfitTargetCoef1 = 4.3;        //ProfitTargetCoef1
input double StopLossCoef1 = 2.6;        //StopLossCoef1
input double ProfitTargetCoef2 = 4;        //ProfitTargetCoef2
...
#define PARABOLICSAR_1 2     //iCustom(NULL,0, "SqParabolicSAR", 0.04, 0.4)
...
string sqStrategyName = "Strategy 0.207";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = ((sqIsRising(SMA_1, 3, false, 1 + 1, 0))
      &&   (sqIsRising("sqClose(NULL,0, 1)", 3, false, 0 + 1, 0)));

     ShortEntrySignal = ((sqIsRising(ADX_1, 4, true, 1 + 1, 2))
      &&   (sqIsFalling(PARABOLICSAR_1, 4, false, 1 + 1, 0)));
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[PARABOLICSAR_1] = iCustom(NULL,0, "SqParabolicSAR", 0.04, 0.4);
