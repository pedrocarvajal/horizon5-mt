...
input string CustomComment = "Strategy_0_394";
...
input int SMAPeriod1 = 11;        //SMAPeriod1
...
#define PIVOTS_1 0     //iCustom(NULL,0, "SqPivots", 6, 0)
...
string sqStrategyName = "Strategy 0.394";
...
if (_sqIsBarOpen == true) {
     ...
     ShortEntrySignal = (NormalizeDouble((double) sqGetIndicatorValue(PIVOTS_1, 0, 1), 6) > NormalizeDouble((double) sqGetIndicatorValue(SMA_1, 0, 1), 6));
