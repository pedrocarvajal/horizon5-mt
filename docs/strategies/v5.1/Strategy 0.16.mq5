...
input string CustomComment = "Strategy_0_16";
...
input int ATRPeriod2 = 153;        //ATRPeriod2
...
string sqStrategyName = "Strategy 0.16";
...
if (_sqIsBarOpen == true) {
     ...
     ShortEntrySignal = (indyCrossesBelow(ATR_1, ATR_2, 1, 1, 0, 0)
      &&   (sqIsRising(PARABOLICSAR_1, 4, true, 1 + 1, 0)));
