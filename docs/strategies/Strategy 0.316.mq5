...
input string CustomComment = "Strategy_0_316";
...
#define ATR_2 1     //iCustom(NULL, 0, "SqATR", 14)
...
string sqStrategyName = "Strategy 0.316";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (sqIsFalling(ATR_1, 2, false, 1 + 1, 0));
