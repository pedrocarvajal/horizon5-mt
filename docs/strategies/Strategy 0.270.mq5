...
input string CustomComment = "Strategy_0_270";
...
input int ADXPeriod1 = 93;        //ADXPeriod1
input int ADXPeriod2 = 70;        //ADXPeriod2
input int ADXPeriod3 = 166;        //ADXPeriod3
input int ADXPeriod4 = 71;        //ADXPeriod4
input int ADXPeriod5 = 92;        //ADXPeriod5
...
#define ADX_3 2     //iCustom(NULL,0, "SqADX", ADXPeriod3)
#define ADX_4 3     //iCustom(NULL,0, "SqADX", ADXPeriod4)
#define ADX_5 4     //iCustom(NULL,0, "SqADX", ADXPeriod5)
...
string sqStrategyName = "Strategy 0.270";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (sqIsFalling(ADX_1, 3, false, 1 + 1, 1));

     ShortEntrySignal = ((sqIsGreaterCount("sqGetIndicatorValue(ADX_2, 0, 1)","sqGetIndicatorValue(ADX_3, 1, 1)",7,true,1))
      &&   indyCrossesAbove(ADX_4, ADX_5, 1, 1, 2, 1));
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ADX_3] = iCustom(NULL,0, "SqADX", ADXPeriod3);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ADX_4] = iCustom(NULL,0, "SqADX", ADXPeriod4);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ADX_5] = iCustom(NULL,0, "SqADX", ADXPeriod5);
...
double sqGetExpressionByIdentification(string id, int shift) {
      if(id == "sqGetIndicatorValue(ADX_2, 0, 1)") {
          return sqGetIndicatorValue(ADX_2, 0, shift + 1);
      }
      if(id == "sqGetIndicatorValue(ADX_3, 1, 1)") {
          return sqGetIndicatorValue(ADX_3, 1, shift + 1);
      }
