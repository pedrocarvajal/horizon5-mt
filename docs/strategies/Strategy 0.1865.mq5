...
input string CustomComment = "Strategy_0_1865";
...
input int EMAPeriod1 = 33;        //EMAPeriod1
input int SMAPeriod1 = 155;        //SMAPeriod1
input int EMAPeriod2 = 86;        //EMAPeriod2
...
string sqStrategyName = "Strategy 0.1865";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (sqIsRising(EMA_1, 5, true, 1 + 1, 0));

     ShortEntrySignal = indyCrossesAbove(SMA_1, EMA_2, 1, 1, 0, 0);
