...
input string CustomComment = "Strategy_0_597";
...
input int EMAPeriod1 = 166;        //EMAPeriod1
input int EMAPeriod2 = 21;        //EMAPeriod2
input int EMAPeriod3 = 90;        //EMAPeriod3
...
string sqStrategyName = "Strategy 0.597";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = ((NormalizeDouble((double) sqGetIndicatorValue(EMA_1, 0, 1), 6) < NormalizeDouble((double) sqClose(NULL,0, 1), 6))
      &&   indyCrossesAbove(EMA_2, EMA_3, 1, 1, 0, 0));

     ShortEntrySignal = (NormalizeDouble((double) sqClose(NULL,0, 1), 6) > NormalizeDouble((double) sqGetIndicatorValue(HIGHEST_1, 0, 1), 6));
