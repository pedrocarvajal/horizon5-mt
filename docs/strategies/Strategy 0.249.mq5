...
input string CustomComment = "Strategy_0_249";
...
input int SMAPeriod1 = 157;        //SMAPeriod1
...
string sqStrategyName = "Strategy 0.249";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = indyCrossesBelow("sqClose(NULL,0, 1)", SMA_1, 0, 1, 0, 0);

     ShortEntrySignal = indyCrossesAbove(EMA_1, LOWEST_1, 1, 1, 0, 0);
