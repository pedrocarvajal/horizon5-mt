...
input string CustomComment = "Strategy_0_554";
...
input int SMAPeriod1 = 169;        //SMAPeriod1
input int EMAPeriod1 = 142;        //EMAPeriod1
input int SMAPeriod2 = 28;        //SMAPeriod2
input int EMAPeriod2 = 17;        //EMAPeriod2
...
input double ProfitTargetCoef2 = 3.2;        //ProfitTargetCoef2
...
string sqStrategyName = "Strategy 0.554";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = indyCrossesBelow(SMA_1, "sqClose(NULL,0, 1)", 1, 0, 0, 0);

     ShortEntrySignal = (((NormalizeDouble((double) sqGetIndicatorValue(EMA_1, 0, 1), 6) < NormalizeDouble((double) sqClose(NULL,0, 1), 6))
      &&   indyCrossesBelow(SMA_2, EMA_2, 1, 1, 0, 0))
