...
input string CustomComment = "Strategy_0_2056";
...
input int SMAPeriod1 = 191;        //SMAPeriod1
input int SMAPeriod2 = 92;        //SMAPeriod2
input int SMAPeriod3 = 135;        //SMAPeriod3
input int EMAPeriod1 = 44;        //EMAPeriod1
...
#define SMA_3 2     //iMA(NULL,0, SMAPeriod3, 0, MODE_SMA, PRICE_CLOSE)
...
string sqStrategyName = "Strategy 0.2056";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (sqIsRising(SMA_1, 11, false, 1 + 1, 0));

     ShortEntrySignal = (indyCrossesAbove(SMA_2, SMA_3, 1, 1, 0, 0)
      &&   (sqIsFalling(EMA_1, 4, true, 1 + 1, 0)));
