...
//|    Generated at 02/11/2026 09:04
//| 
//|    Backtested on XAUUSD_dukascopy / H1, 2021.02.01 - 2026.02.01 
//+------------------------------------------------------------------+
...
input string CustomComment = "Strategy_0_11370";
...
string sqStrategyName = "Strategy 0.11370";
...
if (_sqIsBarOpen == true) {
     ...
     ShortEntrySignal = ((indyCrossesBelow(LOWEST_1, EMA_1, 1, 1, 0, 0)
      &&   (NormalizeDouble((double) sqGetIndicatorValue(LOWEST_2, 0, 1), 6) > NormalizeDouble((double) sqGetIndicatorValue(EMA_2, 0, 1), 6)))
      &&   (sqIsFalling(SMA_1, 4, true, 1 + 1, 0)));
