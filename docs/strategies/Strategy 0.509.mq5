...
//|    Generated at 02/03/2026 12:50
//| 
//|    Backtested on XAUUSD_dukascopy / H1, 2021.01.01 - 2026.02.03 
//+------------------------------------------------------------------+
...
input string CustomComment = "Strategy_0_509";
...
input int ADXPeriod1 = 65;        //ADXPeriod1
input int ADXPeriod2 = 161;        //ADXPeriod2
input int SMAPeriod1 = 17;        //SMAPeriod1
input int SMAPeriod2 = 23;        //SMAPeriod2
input int Period1 = 21;        //Period1
input double ProfitTargetCoef1 = 1;        //ProfitTargetCoef1
input double StopLossCoef1 = 1;        //StopLossCoef1
...
#define ADX_1 0     //iCustom(NULL,0, "SqADX", ADXPeriod1)
#define ADX_2 1     //iCustom(NULL,0, "SqADX", ADXPeriod2)
#define SMA_1 2     //iMA(NULL,0, SMAPeriod1, 0, MODE_SMA, PRICE_CLOSE)
#define SMA_2 3     //iMA(NULL,0, SMAPeriod2, 0, MODE_SMA, PRICE_CLOSE)
#define HIGHEST_1 4     //iCustom(NULL,0, "SqHighest", Period1, PRICE_CLOSE)
#define ATR_1 5     //iCustom(NULL, 0, "SqATR", 14)
...
string sqStrategyName = "Strategy 0.509";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (sqIsLowerCount("sqGetIndicatorValue(ADX_1, 0, 1)","sqGetIndicatorValue(ADX_2, 1, 1)",8,false,1));

     ShortEntrySignal = ((sqIsRising(SMA_1, 4, false, 1 + 1, 0))
      &&   (sqIsLowerCount("sqGetIndicatorValue(SMA_2, 0, 1)","sqGetIndicatorValue(HIGHEST_1, 0, 1)",4,false,1)));
...
double sqGetExpressionByIdentification(string id, int shift) {
      if(id == "sqGetIndicatorValue(ADX_1, 0, 1)") {
          return sqGetIndicatorValue(ADX_1, 0, shift + 1);
      }
      if(id == "sqGetIndicatorValue(ADX_2, 1, 1)") {
          return sqGetIndicatorValue(ADX_2, 1, shift + 1);
      }
      if(id == "sqGetIndicatorValue(SMA_2, 0, 1)") {
          return sqGetIndicatorValue(SMA_2, 0, shift + 1);
      }
      if(id == "sqGetIndicatorValue(HIGHEST_1, 0, 1)") {
          return sqGetIndicatorValue(HIGHEST_1, 0, shift + 1);
      }
