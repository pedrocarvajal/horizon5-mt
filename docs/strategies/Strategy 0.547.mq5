...
input string CustomComment = "Strategy_0_547";
...
input int ADXPeriod1 = 171;        //ADXPeriod1
input int ADXPeriod2 = 42;        //ADXPeriod2
...
string sqStrategyName = "Strategy 0.547";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (NormalizeDouble((double) sqGetIndicatorValue(ADX_1, 0, 1), 6) < NormalizeDouble((double) sqGetIndicatorValue(ADX_2, 0, 1), 6));
