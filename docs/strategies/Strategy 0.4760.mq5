...
input string CustomComment = "Strategy_0_4760";
...
input int ATRPeriod2 = 135;        //ATRPeriod2
...
string sqStrategyName = "Strategy 0.4760";
...
if (_sqIsBarOpen == true) {
     ...
     ShortEntrySignal = ((sqIsRising("sqClose(NULL,0, 1)", 9, false, 0 + 1, 0))
      &&   (sqIsFalling(LOWEST_1, 12, true, 1 + 1, 0)));
