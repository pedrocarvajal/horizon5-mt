...
input string CustomComment = "Strategy_0_184";
...
string sqStrategyName = "Strategy 0.184";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (sqIsGreaterCount("sqGetIndicatorValue(PIVOTS_1, 2, 1)","sqGetIndicatorValue(HIGHEST_1, 0, 1)",10,true,1));
...
double sqGetExpressionByIdentification(string id, int shift) {
      if(id == "sqGetIndicatorValue(PIVOTS_1, 2, 1)") {
          return sqGetIndicatorValue(PIVOTS_1, 2, shift + 1);
      }
