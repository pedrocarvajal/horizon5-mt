...
//|    Generated at 02/17/2026 16:31
//| 
//|    Backtested on XAUUSD_dukascopy / H1, 2017.01.01 - 2022.01.01 
//+------------------------------------------------------------------+
...
input string CustomComment = "Strategy_0_1012";
...
input int SMAPeriod1 = 47;        //SMAPeriod1
input int Period1 = 1;        //Period1
input int EMAPeriod1 = 180;        //EMAPeriod1
input int Period2 = 6;        //Period2
input int EMAPeriod2 = 51;        //EMAPeriod2
input int SMAPeriod2 = 44;        //SMAPeriod2
input int ATRPeriod1 = 101;        //ATRPeriod1
input int ATRPeriod2 = 29;        //ATRPeriod2
input int Period3 = 21;        //Period3
input int Period4 = 16;        //Period4
input double ProfitTargetCoef1 = 4.5;        //ProfitTargetCoef1
input double StopLossCoef1 = 2.7;        //StopLossCoef1
input double ProfitTargetCoef2 = 2.7;        //ProfitTargetCoef2
...
#define EMA_2 4     //iMA(NULL,0, EMAPeriod2, 0, MODE_EMA, PRICE_CLOSE)
#define SMA_2 5     //iMA(NULL,0, SMAPeriod2, 0, MODE_SMA, PRICE_CLOSE)
#define ATR_1 6     //iCustom(NULL,0, "SqATR", ATRPeriod1)
#define ATR_2 7     //iCustom(NULL,0, "SqATR", ATRPeriod2)
#define LOWEST_3 8     //iCustom(NULL,0, "SqLowest", Period3, PRICE_CLOSE)
#define HIGHEST_1 9     //iCustom(NULL,0, "SqHighest", Period4, PRICE_CLOSE)
#define ATR_3 10     //iCustom(NULL, 0, "SqATR", 14)
...
string sqStrategyName = "Strategy 0.1012";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = ((NormalizeDouble((double) sqGetIndicatorValue(SMA_1, 0, 1), 6) < NormalizeDouble((double) sqGetIndicatorValue(LOWEST_1, 0, 1), 6))
      &&   (NormalizeDouble((double) sqGetIndicatorValue(EMA_1, 0, 1), 6) > NormalizeDouble((double) sqGetIndicatorValue(LOWEST_2, 0, 1), 6)));

     ShortEntrySignal = ((indyCrossesAbove(EMA_2, SMA_2, 1, 1, 0, 0)
      &&   (NormalizeDouble((double) sqGetIndicatorValue(ATR_1, 0, 1), 6) > NormalizeDouble((double) sqGetIndicatorValue(ATR_2, 0, 1), 6)))
      &&   indyCrossesAbove(LOWEST_3, HIGHEST_1, 1, 1, 0, 0));
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[LOWEST_3] = iCustom(NULL,0, "SqLowest", Period3, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[HIGHEST_1] = iCustom(NULL,0, "SqHighest", Period4, PRICE_CLOSE);
