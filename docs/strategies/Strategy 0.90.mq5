...
input string CustomComment = "Strategy_0_90";
...
input int SMAPeriod1 = 177;        //SMAPeriod1
...
string sqStrategyName = "Strategy 0.90";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (NormalizeDouble((double) sqClose(NULL,0, 1), 6) < NormalizeDouble((double) sqGetIndicatorValue(SMA_1, 0, 1), 6));

     ShortEntrySignal = indyCrossesAbove(HIGHEST_1, LOWEST_1, 1, 1, 0, 0);
