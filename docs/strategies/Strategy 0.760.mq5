...
input string CustomComment = "Strategy_0_760";
...
input int SMAPeriod1 = 200;        //SMAPeriod1
input int Period1 = 21;        //Period1
input int SMAPeriod2 = 86;        //SMAPeriod2
input int Period2 = 6;        //Period2
input int EMAPeriod2 = 109;        //EMAPeriod2
...
#define HIGHEST_2 4     //iCustom(NULL,0, "SqHighest", Period2, PRICE_CLOSE)
#define EMA_2 5     //iMA(NULL,0, EMAPeriod2, 0, MODE_EMA, PRICE_CLOSE)
...
string sqStrategyName = "Strategy 0.760";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = ((NormalizeDouble((double) sqGetIndicatorValue(EMA_1, 0, 1), 6) < NormalizeDouble((double) sqGetIndicatorValue(SMA_1, 0, 1), 6))
      &&   (NormalizeDouble((double) sqGetIndicatorValue(HIGHEST_1, 0, 1), 6) > NormalizeDouble((double) sqGetIndicatorValue(SMA_2, 0, 1), 6)));

     ShortEntrySignal = ((NormalizeDouble((double) sqGetIndicatorValue(HIGHEST_2, 0, 1), 6) < NormalizeDouble((double) sqClose(NULL,0, 1), 6))
      &&   (NormalizeDouble((double) sqGetIndicatorValue(EMA_2, 0, 1), 6) > NormalizeDouble((double) sqGetIndicatorValue(HIGHEST_2, 0, 1), 6)));
