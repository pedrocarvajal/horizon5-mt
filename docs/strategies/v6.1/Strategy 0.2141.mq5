...
input string CustomComment = "Strategy_0_2141";
...
input int SMAPeriod1 = 21;        //SMAPeriod1
input int Period1 = 6;        //Period1
input int SMAPeriod2 = 70;        //SMAPeriod2
...
#define SMA_2 2     //iMA(NULL,0, SMAPeriod2, 0, MODE_SMA, PRICE_CLOSE)
...
string sqStrategyName = "Strategy 0.2141";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (((sqIsFalling(SMA_1, 4, true, 1 + 1, 0))
      &&   (sqIsFalling("sqClose(NULL,0, 1)", 10, true, 0 + 1, 0)))
      &&   (NormalizeDouble((double) sqClose(NULL,0, 1), 6) < NormalizeDouble((double) sqGetIndicatorValue(LOWEST_1, 0, 1), 6)));

     ShortEntrySignal = ((sqIsFalling(SMA_2, 9, false, 1 + 1, 0))
