...
//|    Generated at 02/11/2026 07:16
//| 
//|    Backtested on BTCUSDT_binance / H1, 2021.02.10 - 2026.02.10 
//+------------------------------------------------------------------+
...
input string CustomComment = "Strategy_0_2542";
...
input int SMAPeriod1 = 164;        //SMAPeriod1
input int EMAPeriod1 = 181;        //EMAPeriod1
input int Period1 = 16;        //Period1
input int EMAPeriod2 = 62;        //EMAPeriod2
input int Period2 = 11;        //Period2
input int Period3 = 1;        //Period3
input int EMAPeriod3 = 15;        //EMAPeriod3
input double ProfitTargetCoef1 = 2.4;        //ProfitTargetCoef1
input double StopLossCoef1 = 2.1;        //StopLossCoef1
input double ProfitTargetCoef2 = 1.3;        //ProfitTargetCoef2
...
input int MinimumSL = 15;   //Minimum SL in pips
input int MinimumPT = 15;   //Minimum PT in pips
...
#define EMA_2 3     //iMA(NULL,0, EMAPeriod2, 0, MODE_EMA, PRICE_CLOSE)
#define LOWEST_2 4     //iCustom(NULL,0, "SqLowest", Period2, PRICE_CLOSE)
#define HIGHEST_1 5     //iCustom(NULL,0, "SqHighest", Period3, PRICE_CLOSE)
#define EMA_3 6     //iMA(NULL,0, EMAPeriod3, 0, MODE_EMA, PRICE_CLOSE)
#define ATR_1 7     //iCustom(NULL, 0, "SqATR", 14)
...
string sqStrategyName = "Strategy 0.2542";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = indyCrossesBelow(SMA_1, EMA_1, 1, 1, 0, 0);

     ShortEntrySignal = (((NormalizeDouble((double) sqClose(NULL,0, 1), 6) > NormalizeDouble((double) sqGetIndicatorValue(LOWEST_1, 0, 1), 6))
      &&   indyCrossesBelow(EMA_2, LOWEST_2, 1, 1, 0, 0))
      &&   (NormalizeDouble((double) sqGetIndicatorValue(HIGHEST_1, 0, 1), 6) < NormalizeDouble((double) sqGetIndicatorValue(EMA_3, 0, 1), 6)));
...
//------------------------
...
)
   {
      ...
      pt = sqFixMarketPrice(sqGetPTLevel("Current", ORDER_TYPE_SELL, openPrice, 2, ProfitTargetCoef2 * sqGetIndicatorValue(ATR_1, 1)), "Current");
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[HIGHEST_1] = iCustom(NULL,0, "SqHighest", Period3, PRICE_CLOSE);
