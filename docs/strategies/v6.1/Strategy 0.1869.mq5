...
input string CustomComment = "Strategy_0_1869";
...
input int SMAPeriod1 = 80;        //SMAPeriod1
...
string sqStrategyName = "Strategy 0.1869";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = indyCrossesBelow(HIGHEST_1, "sqClose(NULL,0, 1)", 1, 0, 0, 0);

     ShortEntrySignal = (NormalizeDouble((double) sqClose(NULL,0, 1), 6) < NormalizeDouble((double) sqGetIndicatorValue(SMA_1, 0, 1), 6));
