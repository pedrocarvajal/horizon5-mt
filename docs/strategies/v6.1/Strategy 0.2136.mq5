...
input string CustomComment = "Strategy_0_2136";
...
input int SMAPeriod1 = 10;        //SMAPeriod1
input int Period1 = 21;        //Period1
input int EMAPeriod1 = 18;        //EMAPeriod1
input int SMAPeriod2 = 152;        //SMAPeriod2
input int Period2 = 16;        //Period2
input int EMAPeriod2 = 41;        //EMAPeriod2
input int ATRPeriod1 = 92;        //ATRPeriod1
...
#define ATR_2 7     //iCustom(NULL, 0, "SqATR", 14)
...
string sqStrategyName = "Strategy 0.2136";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = ((indyCrossesBelow(SMA_1, HIGHEST_1, 1, 1, 0, 0)
      &&   (NormalizeDouble((double) sqGetIndicatorValue(EMA_1, 0, 1), 6) > NormalizeDouble((double) sqGetIndicatorValue(HIGHEST_1, 0, 1), 6)))
      &&   (NormalizeDouble((double) sqGetIndicatorValue(SMA_2, 0, 1), 6) > NormalizeDouble((double) sqGetIndicatorValue(HIGHEST_2, 0, 1), 6)));

     ShortEntrySignal = ((NormalizeDouble((double) sqGetIndicatorValue(EMA_2, 0, 1), 6) > NormalizeDouble((double) sqClose(NULL,0, 1), 6))
      &&   (sqIsRising(ATR_1, 3, false, 1 + 1, 0)));
