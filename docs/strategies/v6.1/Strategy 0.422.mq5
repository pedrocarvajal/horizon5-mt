...
input string CustomComment = "Strategy_0_422";
...
input int SMAPeriod1 = 148;        //SMAPeriod1
input int ATRPeriod1 = 88;        //ATRPeriod1
input int ATRPeriod2 = 15;        //ATRPeriod2
input int ATRPeriod3 = 160;        //ATRPeriod3
input int ATRPeriod4 = 189;        //ATRPeriod4
input int SMAPeriod2 = 53;        //SMAPeriod2
input int SMAPeriod3 = 139;        //SMAPeriod3
input double ProfitTargetCoef1 = 3.6;        //ProfitTargetCoef1
input double StopLossCoef1 = 2.6;        //StopLossCoef1
input double ProfitTargetCoef2 = 1;        //ProfitTargetCoef2
...
#define SMA_3 7     //iMA(NULL,0, SMAPeriod3, 0, MODE_SMA, PRICE_CLOSE)
#define ATR_5 8     //iCustom(NULL, 0, "SqATR", 14)
...
string sqStrategyName = "Strategy 0.422";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (((NormalizeDouble((double) sqGetIndicatorValue(HIGHEST_1, 0, 1), 6) < NormalizeDouble((double) sqGetIndicatorValue(SMA_1, 0, 1), 6))
      &&   indyCrossesBelow(ATR_1, ATR_2, 1, 1, 0, 0))
      &&   indyCrossesAbove(ATR_3, ATR_4, 1, 1, 0, 0));

     ShortEntrySignal = (NormalizeDouble((double) sqGetIndicatorValue(SMA_2, 0, 1), 6) < NormalizeDouble((double) sqGetIndicatorValue(SMA_3, 0, 1), 6));
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[SMA_3] = iMA(NULL,0, SMAPeriod3, 0, MODE_SMA, PRICE_CLOSE);
