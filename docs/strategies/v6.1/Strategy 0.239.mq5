...
input string CustomComment = "Strategy_0_239";
...
input int SMAPeriod1 = 133;        //SMAPeriod1
...
string sqStrategyName = "Strategy 0.239";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (sqIsFalling("sqClose(NULL,0, 1)", 11, false, 0 + 1, 0));

     ShortEntrySignal = indyCrossesAbove(SMA_1, LOWEST_1, 1, 1, 0, 0);
