...
input string CustomComment = "Strategy_0_3163";
...
#define LOWEST_2 3     //iCustom(NULL,0, "SqLowest", Period1, PRICE_CLOSE)
...
string sqStrategyName = "Strategy 0.3163";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (((sqIsRising(EMA_1, 4, true, 1 + 1, 0))
      &&   (NormalizeDouble((double) sqGetIndicatorValue(HIGHEST_1, 0, 1), 6) < NormalizeDouble((double) sqGetIndicatorValue(LOWEST_1, 0, 1), 6)))
      &&   indyCrossesBelow("sqClose(NULL,0, 1)", LOWEST_2, 0, 1, 0, 0));

     ShortEntrySignal = indyCrossesBelow(LOWEST_1, SMA_1, 1, 1, 0, 0);
