...
input string CustomComment = "Strategy_0_2059";
...
input int SMAPeriod1 = 70;        //SMAPeriod1
...
#define LOWEST_1 1     //iCustom(NULL,0, "SqLowest", Period2, PRICE_CLOSE)
...
string sqStrategyName = "Strategy 0.2059";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = ((sqIsFalling(HIGHEST_1, 3, true, 1 + 1, 0))
      &&   (sqIsRising(LOWEST_1, 10, true, 1 + 1, 0)));

     ShortEntrySignal = (sqIsFalling(SMA_1, 12, true, 1 + 1, 0));
