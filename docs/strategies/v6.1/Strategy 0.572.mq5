...
input string CustomComment = "Strategy_0_572";
...
input int EMAPeriod1 = 19;        //EMAPeriod1
input int SMAPeriod1 = 39;        //SMAPeriod1
input int ATRPeriod1 = 190;        //ATRPeriod1
input int ATRPeriod2 = 67;        //ATRPeriod2
input int EMAPeriod2 = 114;        //EMAPeriod2
input double ProfitTargetCoef1 = 4.8;        //ProfitTargetCoef1
...
#define ATR_3 5     //iCustom(NULL, 0, "SqATR", 14)
...
string sqStrategyName = "Strategy 0.572";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (((sqIsRising("sqClose(NULL,0, 1)", 9, true, 0 + 1, 0))
      &&   (NormalizeDouble((double) sqGetIndicatorValue(EMA_1, 0, 1), 6) < NormalizeDouble((double) sqGetIndicatorValue(SMA_1, 0, 1), 6)))
      &&   (NormalizeDouble((double) sqGetIndicatorValue(ATR_1, 0, 1), 6) < NormalizeDouble((double) sqGetIndicatorValue(ATR_2, 0, 1), 6)));

     ShortEntrySignal = indyCrossesBelow("sqClose(NULL,0, 1)", EMA_2, 0, 1, 0, 0);
