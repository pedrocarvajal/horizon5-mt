...
input string CustomComment = "Strategy_0_2088";
...
input int SMAPeriod2 = 173;        //SMAPeriod2
...
input double ProfitTargetCoef2 = 1.9;        //ProfitTargetCoef2
...
#define SMA_2 1     //iMA(NULL,0, SMAPeriod2, 0, MODE_SMA, PRICE_CLOSE)
...
string sqStrategyName = "Strategy 0.2088";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = ((sqIsFalling(SMA_1, 10, true, 1 + 1, 0))
      &&   indyCrossesAbove(SMA_2, HIGHEST_1, 1, 1, 0, 0));

     ShortEntrySignal = ((sqIsFalling("sqClose(NULL,0, 1)", 8, false, 0 + 1, 0))
      &&   indyCrossesBelow(LOWEST_1, EMA_1, 1, 1, 0, 0));
