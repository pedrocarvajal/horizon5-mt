...
input string CustomComment = "Strategy_0_277";
...
input int EMAPeriod1 = 92;        //EMAPeriod1
input int EMAPeriod2 = 67;        //EMAPeriod2
input int ATRPeriod1 = 71;        //ATRPeriod1
input int ATRPeriod2 = 107;        //ATRPeriod2
input int EMAPeriod3 = 124;        //EMAPeriod3
input int Period1 = 21;        //Period1
input int SMAPeriod1 = 126;        //SMAPeriod1
...
#define LOWEST_2 7     //iCustom(NULL,0, "SqLowest", Period2, PRICE_CLOSE)
...
string sqStrategyName = "Strategy 0.277";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = indyCrossesBelow(EMA_1, EMA_2, 1, 1, 0, 0);

     ShortEntrySignal = ((indyCrossesAbove(ATR_1, ATR_2, 1, 1, 0, 0)
      &&   indyCrossesBelow(EMA_3, LOWEST_1, 1, 1, 0, 0))
      &&   (NormalizeDouble((double) sqGetIndicatorValue(SMA_1, 0, 1), 6) < NormalizeDouble((double) sqGetIndicatorValue(LOWEST_2, 0, 1), 6)));
