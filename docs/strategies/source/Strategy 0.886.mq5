...
input string CustomComment = "Strategy_0_886";
...
input int EMAPeriod1 = 126;        //EMAPeriod1
...
#define LOWEST_2 1     //iCustom(NULL,0, "SqLowest", Period2, PRICE_CLOSE)
#define LOWEST_3 2     //iCustom(NULL,0, "SqLowest", Period3, PRICE_CLOSE)
...
string sqStrategyName = "Strategy 0.886";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = ((NormalizeDouble((double) sqGetIndicatorValue(LOWEST_1, 0, 1), 6) < NormalizeDouble((double) sqGetIndicatorValue(LOWEST_2, 0, 1), 6))
      &&   indyCrossesBelow(LOWEST_3, EMA_1, 1, 1, 0, 0));
