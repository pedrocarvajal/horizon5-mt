...
input string CustomComment = "Strategy_0_1150";
...
input int SMAPeriod1 = 187;        //SMAPeriod1
input int ATRPeriod1 = 179;        //ATRPeriod1
input int ATRPeriod2 = 6;        //ATRPeriod2
input int EMAPeriod1 = 73;        //EMAPeriod1
input int Period2 = 21;        //Period2
input int SMAPeriod2 = 116;        //SMAPeriod2
input int Period3 = 16;        //Period3
input double ProfitTargetCoef1 = 4;        //ProfitTargetCoef1
input double StopLossCoef1 = 3.7;        //StopLossCoef1
input double ProfitTargetCoef2 = 4.8;        //ProfitTargetCoef2
input double StopLossCoef2 = 4.2;        //StopLossCoef2
...
#define EMA_1 4     //iMA(NULL,0, EMAPeriod1, 0, MODE_EMA, PRICE_CLOSE)
#define LOWEST_2 5     //iCustom(NULL,0, "SqLowest", Period2, PRICE_CLOSE)
#define SMA_2 6     //iMA(NULL,0, SMAPeriod2, 0, MODE_SMA, PRICE_CLOSE)
#define LOWEST_3 7     //iCustom(NULL,0, "SqLowest", Period3, PRICE_CLOSE)
#define ATR_3 8     //iCustom(NULL, 0, "SqATR", 14)
...
string sqStrategyName = "Strategy 0.1150";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = ((NormalizeDouble((double) sqGetIndicatorValue(LOWEST_1, 0, 1), 6) > NormalizeDouble((double) sqGetIndicatorValue(SMA_1, 0, 1), 6))
      &&   (NormalizeDouble((double) sqGetIndicatorValue(ATR_1, 0, 1), 6) < NormalizeDouble((double) sqGetIndicatorValue(ATR_2, 0, 1), 6)));

     ShortEntrySignal = ((NormalizeDouble((double) sqGetIndicatorValue(EMA_1, 0, 1), 6) > NormalizeDouble((double) sqGetIndicatorValue(LOWEST_2, 0, 1), 6))
      &&   indyCrossesBelow(SMA_2, LOWEST_3, 1, 1, 0, 0));
