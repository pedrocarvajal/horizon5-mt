...
input string CustomComment = "SP500Strategy_0_2644";
...
input int EMAPeriod1 = 87;        //EMAPeriod1
input int EMAPeriod2 = 37;        //EMAPeriod2
input double ProfitTargetCoef1 = 2.19;        //ProfitTargetCoef1
input double StopLossCoef1 = 1.74;        //StopLossCoef1
...
#define HIGHEST_1 3     //iCustom(NULL,0, "SqHighest", 16, PRICE_HIGH)
...
string sqStrategyName = "Strategy 0.2644";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = ((NormalizeDouble((double) sqGetIndicatorValue(PIVOTS_1, 5, 1), 6) <= NormalizeDouble((double) sqGetIndicatorValue(PIVOTS_1, 1, 1), 6))
      &&   indyCrossesBelow(EMA_1, EMA_2, 1, 1, 0, 0));
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[HIGHEST_1] = iCustom(NULL,0, "SqHighest", 16, PRICE_HIGH);
