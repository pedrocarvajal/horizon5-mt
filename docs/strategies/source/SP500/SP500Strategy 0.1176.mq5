...
input string CustomComment = "SP500Strategy_0_1176";
...
input int EMAPeriod1 = 11;        //EMAPeriod1
input double ProfitTargetCoef1 = 1.27;        //ProfitTargetCoef1
...
#define HIGHEST_1 1     //iCustom(NULL,0, "SqHighest", 62, PRICE_HIGH)
...
string sqStrategyName = "Strategy 0.1176";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = ((sqIsFalling(EMA_1, 6, true, 1 + 1, 0))
...
//------------------------
...
)
   {
      ...
      if(_ticket > 0) {
         ...
         sqSetOrderExpiration(_ticket, 17);
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[HIGHEST_1] = iCustom(NULL,0, "SqHighest", 62, PRICE_HIGH);
