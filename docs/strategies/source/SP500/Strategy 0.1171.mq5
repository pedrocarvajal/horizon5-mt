...
input string CustomComment = "Strategy_0_1171";
...
input int ATRPeriod1 = 124;        //ATRPeriod1
input int ATRPeriod2 = 152;        //ATRPeriod2
input int Period1 = 21;        //Period1
input int Period2 = 16;        //Period2
input int SMAPeriod1 = 77;        //SMAPeriod1
input int SMAPeriod2 = 126;        //SMAPeriod2
input double ProfitTargetCoef1 = 4.2;        //ProfitTargetCoef1
input double StopLossCoef1 = 3.6;        //StopLossCoef1
input double ProfitTargetCoef2 = 2.1;        //ProfitTargetCoef2
input double StopLossCoef2 = 3.9;        //StopLossCoef2
...
#define HIGHEST_1 3     //iCustom(NULL,0, "SqHighest", Period2, PRICE_CLOSE)
#define SMA_1 4     //iMA(NULL,0, SMAPeriod1, 0, MODE_SMA, PRICE_CLOSE)
#define SMA_2 5     //iMA(NULL,0, SMAPeriod2, 0, MODE_SMA, PRICE_CLOSE)
#define LOWEST_2 6     //iCustom(NULL,0, "SqLowest", Period2, PRICE_CLOSE)
#define ATR_3 7     //iCustom(NULL, 0, "SqATR", 14)
...
string sqStrategyName = "Strategy 0.1171";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = indyCrossesBelow(ATR_1, ATR_2, 1, 1, 0, 0);

     ShortEntrySignal = ((indyCrossesBelow(LOWEST_1, HIGHEST_1, 1, 1, 0, 0)
      &&   (NormalizeDouble((double) sqGetIndicatorValue(SMA_1, 0, 1), 6) < NormalizeDouble((double) sqGetIndicatorValue(SMA_2, 0, 1), 6)))
      &&   indyCrossesBelow(LOWEST_2, LOWEST_1, 1, 1, 0, 0));
