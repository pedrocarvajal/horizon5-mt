...
input string CustomComment = "SP500Strategy_0_1723";
...
input int Period1 = 34;        //Period1
input double ProfitTargetCoef1 = 2.11;        //ProfitTargetCoef1
input double StopLossCoef1 = 1.75;        //StopLossCoef1
...
#define PIVOTS_1 0     //iCustom(NULL,0, "SqPivots", 15, 5)
#define LOWEST_1 1     //iCustom(NULL,0, "SqLowest", Period1, PRICE_LOW)
#define BOLLINGERBANDS_1 2     //iBands(NULL,0, 10, 0, 1.9, PRICE_CLOSE)
...
string sqStrategyName = "Strategy 0.1723";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = indyCrossesBelow(PIVOTS_1, LOWEST_1, 1, 1, 4, 0);
...
bool initIndicators(){
   ...
   indicatorHandles[PIVOTS_1] = iCustom(NULL,0, "SqPivots", 15, 5);
