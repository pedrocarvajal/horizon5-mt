...
input string CustomComment = "SP500Strategy_0_177";
...
input int SMAPeriod1 = 26;        //SMAPeriod1
input int EMAPeriod1 = 30;        //EMAPeriod1
input double ProfitTargetCoef1 = 3.44;        //ProfitTargetCoef1
input double StopLossCoef1 = 1.14;        //StopLossCoef1
...
#define HIGHESTINRANGE_1 2     //iCustom(NULL,0, "SqHighestInRange", "10:00", "8:30")
...
string sqStrategyName = "Strategy 0.177";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = ((sqIsFalling(SMA_1, 3, false, 1 + 1, 0))
      &&   (sqIsRising(EMA_1, 4, true, 1 + 1, 0)));
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[HIGHESTINRANGE_1] = iCustom(NULL,0, "SqHighestInRange", "10:00", "8:30");
