...
input string CustomComment = "SP500Strategy_0_1962";
...
input int EMAPeriod2 = 46;        //EMAPeriod2
input double ProfitTargetCoef1 = 2.46;        //ProfitTargetCoef1
input double StopLossCoef1 = 1.8;        //StopLossCoef1
...
#define HIGHEST_1 2     //iCustom(NULL,0, "SqHighest", 88, PRICE_HIGH)
...
string sqStrategyName = "Strategy 0.1962";
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[HIGHEST_1] = iCustom(NULL,0, "SqHighest", 88, PRICE_HIGH);
