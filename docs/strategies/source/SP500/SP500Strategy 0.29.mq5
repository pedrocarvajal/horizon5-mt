...
input string CustomComment = "SP500Strategy_0_29";
...
input double ProfitTargetCoef1 = 3.37;        //ProfitTargetCoef1
...
#define HIGHEST_2 1     //iCustom(NULL,0, "SqHighest", 45, PRICE_HIGH)
...
string sqStrategyName = "Strategy 0.29";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (sqIsFalling(HIGHEST_1, 11, true, 1 + 1, 0));
...
//------------------------
...
)
   {
      ...
      if(_ticket > 0) {
         ...
         sqSetOrderExpiration(_ticket, 15);
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[HIGHEST_2] = iCustom(NULL,0, "SqHighest", 45, PRICE_HIGH);
