...
input string CustomComment = "Strategy_0_522";
...
input int ATRPeriod1 = 170;        //ATRPeriod1
input int ATRPeriod2 = 175;        //ATRPeriod2
input int Period1 = 21;        //Period1
input int SMAPeriod1 = 125;        //SMAPeriod1
input int SMAPeriod2 = 104;        //SMAPeriod2
...
input double StopLossCoef2 = 4.3;        //StopLossCoef2
...
string sqStrategyName = "Strategy 0.522";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (indyCrossesAbove(ATR_1, ATR_2, 1, 1, 0, 0)
      &&   (NormalizeDouble((double) sqGetIndicatorValue(LOWEST_1, 0, 1), 6) < NormalizeDouble((double) sqGetIndicatorValue(SMA_1, 0, 1), 6)));

     ShortEntrySignal = ((NormalizeDouble((double) sqClose(NULL,0, 1), 6) > NormalizeDouble((double) sqGetIndicatorValue(SMA_2, 0, 1), 6))
