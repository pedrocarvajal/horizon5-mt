...
input string CustomComment = "SP500Strategy_0_1137";
...
input int BollingerBandsPrd1 = 9;        //BollingerBandsPrd1
input double ProfitTargetCoef1 = 4.17;        //ProfitTargetCoef1
input double StopLossCoef1 = 1.08;        //StopLossCoef1
...
#define BOLLINGERBANDS_2 1     //iBands(NULL,0, 50, 0, 2.1, PRICE_CLOSE)
...
string sqStrategyName = "Strategy 0.1137";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = indyCrossesAbove(BOLLINGERBANDS_1, "sqClose(NULL,0, 1)", 1, 0, 1 + 1, 0);
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[BOLLINGERBANDS_2] = iBands(NULL,0, 50, 0, 2.1, PRICE_CLOSE);
