...
input string CustomComment = "SP500Strategy_0_2661";
...
input int EMAPeriod1 = 49;        //EMAPeriod1
input int EMAPeriod2 = 63;        //EMAPeriod2
input double ProfitTargetCoef1 = 2.33;        //ProfitTargetCoef1
input double StopLossCoef1 = 1.56;        //StopLossCoef1
...
#define HIGHEST_1 2     //iCustom(NULL,0, "SqHighest", 19, PRICE_HIGH)
...
string sqStrategyName = "Strategy 0.2661";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = indyCrossesAbove(EMA_1, EMA_2, 1, 1, 0, 0);
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[HIGHEST_1] = iCustom(NULL,0, "SqHighest", 19, PRICE_HIGH);
