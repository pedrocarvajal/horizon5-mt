...
//|    Generated at 02/20/2026 10:42
//| 
//|    Backtested on USATECHIDXUSD_dukascopy / H1, 2021.01.01 - 2026.01.01 
//+------------------------------------------------------------------+
...
input string CustomComment = "Strategy_0_678";
...
input int Period2 = 21;        //Period2
input int ATRPeriod1 = 77;        //ATRPeriod1
input int ATRPeriod2 = 120;        //ATRPeriod2
input int Period3 = 6;        //Period3
input int EMAPeriod1 = 53;        //EMAPeriod1
input int EMAPeriod2 = 34;        //EMAPeriod2
input int EMAPeriod3 = 147;        //EMAPeriod3
input int Period4 = 16;        //Period4
input double ProfitTargetCoef1 = 4.1;        //ProfitTargetCoef1
input double StopLossCoef1 = 4.7;        //StopLossCoef1
input double ProfitTargetCoef2 = 1.2;        //ProfitTargetCoef2
input double StopLossCoef2 = 2.2;        //StopLossCoef2
...
#define HIGHEST_2 1     //iCustom(NULL,0, "SqHighest", Period2, PRICE_CLOSE)
#define ATR_1 2     //iCustom(NULL,0, "SqATR", ATRPeriod1)
#define ATR_2 3     //iCustom(NULL,0, "SqATR", ATRPeriod2)
#define LOWEST_1 4     //iCustom(NULL,0, "SqLowest", Period3, PRICE_CLOSE)
#define EMA_1 5     //iMA(NULL,0, EMAPeriod1, 0, MODE_EMA, PRICE_CLOSE)
#define EMA_2 6     //iMA(NULL,0, EMAPeriod2, 0, MODE_EMA, PRICE_CLOSE)
#define EMA_3 7     //iMA(NULL,0, EMAPeriod3, 0, MODE_EMA, PRICE_CLOSE)
#define LOWEST_2 8     //iCustom(NULL,0, "SqLowest", Period4, PRICE_CLOSE)
#define ATR_3 9     //iCustom(NULL, 0, "SqATR", 14)
...
string sqStrategyName = "Strategy 0.678";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = ((NormalizeDouble((double) sqGetIndicatorValue(HIGHEST_1, 0, 1), 6) < NormalizeDouble((double) sqGetIndicatorValue(HIGHEST_2, 0, 1), 6))
      &&   (NormalizeDouble((double) sqGetIndicatorValue(ATR_1, 0, 1), 6) < NormalizeDouble((double) sqGetIndicatorValue(ATR_2, 0, 1), 6)));

     ShortEntrySignal = ((indyCrossesAbove(LOWEST_1, EMA_1, 1, 1, 0, 0)
      &&   indyCrossesBelow(EMA_2, EMA_3, 1, 1, 0, 0))
      &&   (NormalizeDouble((double) sqGetIndicatorValue(LOWEST_2, 0, 1), 6) > NormalizeDouble((double) sqClose(NULL,0, 1), 6)));
...
//------------------------
...
)
   {
      ...
      sl = sqFixMarketPrice(sqGetSLLevel("Current", ORDER_TYPE_SELL, openPrice, 2, StopLossCoef2 * sqGetIndicatorValue(ATR_3, 1)), "Current");
      pt = sqFixMarketPrice(sqGetPTLevel("Current", ORDER_TYPE_SELL, openPrice, 2, ProfitTargetCoef2 * sqGetIndicatorValue(ATR_3, 1)), "Current");
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[LOWEST_1] = iCustom(NULL,0, "SqLowest", Period3, PRICE_CLOSE);
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[LOWEST_2] = iCustom(NULL,0, "SqLowest", Period4, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_3] = iCustom(NULL, 0, "SqATR", 14);
...
//+----------------------------- Include from /MetaTrader5/CustomFunctions/.gitkeep -------------------------------------+
