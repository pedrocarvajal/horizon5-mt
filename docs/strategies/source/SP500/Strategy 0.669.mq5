...
input string CustomComment = "Strategy_0_669";
...
input int ATRPeriod1 = 146;        //ATRPeriod1
input int ATRPeriod2 = 70;        //ATRPeriod2
input int Period1 = 21;        //Period1
input int Period2 = 1;        //Period2
input int ATRPeriod3 = 145;        //ATRPeriod3
input int ATRPeriod4 = 51;        //ATRPeriod4
input int EMAPeriod1 = 157;        //EMAPeriod1
...
#define HIGHEST_1 6     //iCustom(NULL,0, "SqHighest", Period2, PRICE_CLOSE)
#define EMA_1 7     //iMA(NULL,0, EMAPeriod1, 0, MODE_EMA, PRICE_CLOSE)
...
string sqStrategyName = "Strategy 0.669";
...
if (_sqIsBarOpen == true) {
     ...
     ShortEntrySignal = ((indyCrossesAbove(LOWEST_1, LOWEST_2, 1, 1, 0, 0)
      &&   (NormalizeDouble((double) sqGetIndicatorValue(ATR_3, 0, 1), 6) < NormalizeDouble((double) sqGetIndicatorValue(ATR_4, 0, 1), 6)))
      &&   (NormalizeDouble((double) sqGetIndicatorValue(HIGHEST_1, 0, 1), 6) > NormalizeDouble((double) sqGetIndicatorValue(EMA_1, 0, 1), 6)));
