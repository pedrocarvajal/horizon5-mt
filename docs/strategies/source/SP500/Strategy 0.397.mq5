...
input string CustomComment = "Strategy_0_397";
...
#define HIGHEST_1 5     //iCustom(NULL,0, "SqHighest", Period1, PRICE_CLOSE)
...
string sqStrategyName = "Strategy 0.397";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (((NormalizeDouble((double) sqGetIndicatorValue(EMA_1, 0, 1), 6) < NormalizeDouble((double) sqGetIndicatorValue(LOWEST_1, 0, 1), 6))
      ...
      &&   (NormalizeDouble((double) sqClose(NULL,0, 1), 6) > NormalizeDouble((double) sqGetIndicatorValue(LOWEST_2, 0, 1), 6)));

     ShortEntrySignal = (indyCrossesBelow("sqClose(NULL,0, 1)", SMA_2, 0, 1, 0, 0)
      &&   (NormalizeDouble((double) sqClose(NULL,0, 1), 6) < NormalizeDouble((double) sqGetIndicatorValue(HIGHEST_1, 0, 1), 6)));
