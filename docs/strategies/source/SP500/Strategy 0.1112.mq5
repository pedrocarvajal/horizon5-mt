...
input string CustomComment = "Strategy_0_1112";
...
input int EMAPeriod1 = 131;        //EMAPeriod1
input int Period1 = 1;        //Period1
input int SMAPeriod1 = 54;        //SMAPeriod1
input int Period2 = 6;        //Period2
input int EMAPeriod2 = 31;        //EMAPeriod2
input int EMAPeriod3 = 82;        //EMAPeriod3
...
string sqStrategyName = "Strategy 0.1112";
...
if (_sqIsBarOpen == true) {
     ...
     ShortEntrySignal = ((indyCrossesBelow("sqClose(NULL,0, 1)", SMA_1, 0, 1, 0, 0)
      &&   indyCrossesBelow(HIGHEST_2, EMA_2, 1, 1, 0, 0))
      &&   (NormalizeDouble((double) sqGetIndicatorValue(LOWEST_1, 0, 1), 6) < NormalizeDouble((double) sqGetIndicatorValue(EMA_3, 0, 1), 6)));
