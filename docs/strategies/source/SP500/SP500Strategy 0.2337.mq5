...
input string CustomComment = "SP500Strategy_0_2337";
...
input int ATRPeriod1 = 9;        //ATRPeriod1
...
#define HIGHESTINRANGE_1 1     //iCustom(NULL,0, "SqHighestInRange", "8:30", "23:30")
...
string sqStrategyName = "Strategy 0.2337";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (sqIsRising(ATR_1, 5, false, 1 + 1, 0));
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[HIGHESTINRANGE_1] = iCustom(NULL,0, "SqHighestInRange", "8:30", "23:30");
