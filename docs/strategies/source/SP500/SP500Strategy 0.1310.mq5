...
//| 
//|    Backtested on SP500_dukascopy / H1, 2020.01.01 - 2025.12.31 
//+------------------------------------------------------------------+
...
input string CustomComment = "SP500Strategy_0_1310";
...
input double ProfitTargetCoef1 = 3.02;        //ProfitTargetCoef1
input double StopLossCoef1 = 2.79;        //StopLossCoef1
...
#define LOWESTINRANGE_1 2     //iCustom(NULL,0, "SqLowestInRange", "8:30", "4:30")
...
string sqStrategyName = "Strategy 0.1310";
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice(sqGetIndicatorValue(LOWESTINRANGE_1, 0, 1), "Current");
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[LOWESTINRANGE_1] = iCustom(NULL,0, "SqLowestInRange", "8:30", "4:30");
