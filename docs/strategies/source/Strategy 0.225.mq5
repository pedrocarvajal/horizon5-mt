...
input string CustomComment = "Strategy_0_225";
...
input int SMAPeriod1 = 119;        //SMAPeriod1
input int EMAPeriod1 = 75;        //EMAPeriod1
input int Period1 = 21;        //Period1
input int SMAPeriod2 = 79;        //SMAPeriod2
input int SMAPeriod3 = 72;        //SMAPeriod3
...
#define SMA_3 4     //iMA(NULL,0, SMAPeriod3, 0, MODE_SMA, PRICE_CLOSE)
...
string sqStrategyName = "Strategy 0.225";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = indyCrossesAbove(SMA_1, EMA_1, 1, 1, 0, 0);

     ShortEntrySignal = (indyCrossesAbove(LOWEST_1, SMA_2, 1, 1, 0, 0)
      &&   indyCrossesBelow(SMA_3, LOWEST_2, 1, 1, 0, 0));
