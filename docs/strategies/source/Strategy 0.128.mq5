...
input string CustomComment = "Strategy_0_128";
...
input int EMAPeriod1 = 199;        //EMAPeriod1
input int ATRPeriod1 = 123;        //ATRPeriod1
input int ATRPeriod2 = 50;        //ATRPeriod2
input int Period1 = 1;        //Period1
input int SMAPeriod1 = 20;        //SMAPeriod1
input int ATRPeriod3 = 53;        //ATRPeriod3
input int ATRPeriod4 = 176;        //ATRPeriod4
...
#define ATR_3 5     //iCustom(NULL,0, "SqATR", ATRPeriod3)
#define ATR_4 6     //iCustom(NULL,0, "SqATR", ATRPeriod4)
#define ATR_5 7     //iCustom(NULL, 0, "SqATR", 14)
...
string sqStrategyName = "Strategy 0.128";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = indyCrossesAbove("sqClose(NULL,0, 1)", EMA_1, 0, 1, 0, 0);

     ShortEntrySignal = ((indyCrossesBelow(ATR_1, ATR_2, 1, 1, 0, 0)
      &&   indyCrossesBelow(LOWEST_1, SMA_1, 1, 1, 0, 0))
