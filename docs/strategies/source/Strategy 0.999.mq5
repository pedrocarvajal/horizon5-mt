...
input string CustomComment = "Strategy_0_999";
...
input int ATRPeriod1 = 65;        //ATRPeriod1
input int ATRPeriod2 = 105;        //ATRPeriod2
input int Period1 = 16;        //Period1
input int SMAPeriod1 = 121;        //SMAPeriod1
input int SMAPeriod2 = 32;        //SMAPeriod2
input int Period2 = 21;        //Period2
input int SMAPeriod3 = 190;        //SMAPeriod3
...
input double StopLossCoef2 = 2.3;        //StopLossCoef2
...
#define SMA_3 6     //iMA(NULL,0, SMAPeriod3, 0, MODE_SMA, PRICE_CLOSE)
#define HIGHEST_1 7     //iCustom(NULL,0, "SqHighest", Period3, PRICE_CLOSE)
...
string sqStrategyName = "Strategy 0.999";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = ((NormalizeDouble((double) sqGetIndicatorValue(ATR_1, 0, 1), 6) < NormalizeDouble((double) sqGetIndicatorValue(ATR_2, 0, 1), 6))
      &&   indyCrossesAbove(LOWEST_1, SMA_1, 1, 1, 0, 0));

     ShortEntrySignal = (((NormalizeDouble((double) sqGetIndicatorValue(SMA_2, 0, 1), 6) > NormalizeDouble((double) sqGetIndicatorValue(LOWEST_2, 0, 1), 6))
      &&   indyCrossesAbove(SMA_3, "sqClose(NULL,0, 1)", 1, 0, 0, 0))
      &&   indyCrossesBelow(HIGHEST_1, "sqClose(NULL,0, 1)", 1, 0, 0, 0));
