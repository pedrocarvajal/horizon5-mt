...
input string CustomComment = "Strategy_0_848";
...
input int EMAPeriod1 = 95;        //EMAPeriod1
input int Period1 = 16;        //Period1
input int SMAPeriod1 = 104;        //SMAPeriod1
input int ATRPeriod1 = 41;        //ATRPeriod1
input int ATRPeriod2 = 161;        //ATRPeriod2
input int SMAPeriod2 = 196;        //SMAPeriod2
input int Period2 = 11;        //Period2
input int ATRPeriod3 = 153;        //ATRPeriod3
input int ATRPeriod4 = 191;        //ATRPeriod4
input double ProfitTargetCoef1 = 3.3;        //ProfitTargetCoef1
input double StopLossCoef1 = 4.6;        //StopLossCoef1
input double ProfitTargetCoef2 = 2;        //ProfitTargetCoef2
input double StopLossCoef2 = 3.1;        //StopLossCoef2
...
#define LOWEST_2 6     //iCustom(NULL,0, "SqLowest", Period2, PRICE_CLOSE)
#define ATR_3 7     //iCustom(NULL,0, "SqATR", ATRPeriod3)
#define ATR_4 8     //iCustom(NULL,0, "SqATR", ATRPeriod4)
#define ATR_5 9     //iCustom(NULL, 0, "SqATR", 14)
...
string sqStrategyName = "Strategy 0.848";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = ((NormalizeDouble((double) sqGetIndicatorValue(EMA_1, 0, 1), 6) > NormalizeDouble((double) sqGetIndicatorValue(LOWEST_1, 0, 1), 6))
      &&   (NormalizeDouble((double) sqGetIndicatorValue(SMA_1, 0, 1), 6) < NormalizeDouble((double) sqClose(NULL,0, 1), 6)));

     ShortEntrySignal = ((indyCrossesAbove(ATR_1, ATR_2, 1, 1, 0, 0)
      &&   (NormalizeDouble((double) sqGetIndicatorValue(SMA_2, 0, 1), 6) > NormalizeDouble((double) sqGetIndicatorValue(LOWEST_2, 0, 1), 6)))
      &&   (NormalizeDouble((double) sqGetIndicatorValue(ATR_3, 0, 1), 6) > NormalizeDouble((double) sqGetIndicatorValue(ATR_4, 0, 1), 6)));
...
//------------------------
...
)
   {
      ...
      pt = sqFixMarketPrice(sqGetPTLevel("Current", ORDER_TYPE_SELL, openPrice, 2, ProfitTargetCoef2 * sqGetIndicatorValue(ATR_5, 1)), "Current");
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_5] = iCustom(NULL, 0, "SqATR", 14);
