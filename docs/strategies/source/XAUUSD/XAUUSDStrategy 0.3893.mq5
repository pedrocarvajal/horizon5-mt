...
input string CustomComment = "XAUUSDStrategy_0_3893";
...
input double ProfitTargetCoef1 = 3.26;        //ProfitTargetCoef1
input double StopLossCoef1 = 2.42;        //StopLossCoef1
...
#define BOLLINGERBANDS_1 1     //iBands(NULL,0, 20, 0, 2.0, PRICE_CLOSE)
...
string sqStrategyName = "Strategy 0.3893";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (sqIsFalling(ATR_1, 10, false, 1 + 1, 0));
