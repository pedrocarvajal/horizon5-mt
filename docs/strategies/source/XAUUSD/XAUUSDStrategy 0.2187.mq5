...
input string CustomComment = "XAUUSDStrategy_0_2187";
...
input int SMAPeriod1 = 5;        //SMAPeriod1
input int SMAPeriod2 = 8;        //SMAPeriod2
input double ProfitTargetCoef1 = 2.73;        //ProfitTargetCoef1
input double StopLossCoef1 = 1.99;        //StopLossCoef1
...
#define HIGHESTINRANGE_1 2     //iCustom(NULL,0, "SqHighestInRange", "0:30", "16:30")
...
string sqStrategyName = "Strategy 0.2187";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = indyCrossesBelow(SMA_1, SMA_2, 1, 1, 0, 0);
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[HIGHESTINRANGE_1] = iCustom(NULL,0, "SqHighestInRange", "0:30", "16:30");
