...
input string CustomComment = "XAUUSDStrategy_0_1003";
...
input int Period1 = 23;        //Period1
input int ATRPeriod1 = 6;        //ATRPeriod1
input int ATRPeriod2 = 32;        //ATRPeriod2
input double ProfitTargetCoef1 = 2.77;        //ProfitTargetCoef1
input double StopLossCoef1 = 2.15;        //StopLossCoef1
...
#define HIGHEST_2 3     //iCustom(NULL,0, "SqHighest", 31, PRICE_HIGH)
...
string sqStrategyName = "Strategy 0.1003";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = ((sqIsRising(HIGHEST_1, 12, true, 1 + 1, 0))
...
//------------------------
...
)
   {
      ...
      pt = sqFixMarketPrice(sqGetPTLevel("Current", ORDER_TYPE_BUY_STOP, openPrice, 2, ProfitTargetCoef1 * sqGetIndicatorValue(ATR_3, 1)), "Current");
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[HIGHEST_2] = iCustom(NULL,0, "SqHighest", 31, PRICE_HIGH);
