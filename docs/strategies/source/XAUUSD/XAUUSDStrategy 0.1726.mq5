...
input string CustomComment = "XAUUSDStrategy_0_1726";
...
input double ProfitTargetCoef1 = 3.94;        //ProfitTargetCoef1
...
#define HIGHESTINRANGE_1 1     //iCustom(NULL,0, "SqHighestInRange", "4:30", "18:00")
...
string sqStrategyName = "Strategy 0.1726";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (sqIsRising(HIGHEST_1, 2, false, 1 + 1, 0));
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[HIGHESTINRANGE_1] = iCustom(NULL,0, "SqHighestInRange", "4:30", "18:00");
