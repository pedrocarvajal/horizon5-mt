...
//|    Generated at 03/15/2026 07:40
//| 
//|    Backtested on XAUUSD_dukascopy / H1, 2020.01.01 - 2025.12.31 
//+------------------------------------------------------------------+
...
input string CustomComment = "XAUUSDStrategy_0_2497";
...
input int Period1 = 22;        //Period1
input int BollingerBandsPrd1 = 42;        //BollingerBandsPrd1
input double ProfitTargetCoef1 = 2.34;        //ProfitTargetCoef1
input double StopLossCoef1 = 1.51;        //StopLossCoef1
...
input int mmStopLossPips = 300;
input double mmLotsIfNoMM = 0.01;
input double mmMaxLots = 9999.0;
...
#define HIGHEST_1 0     //iCustom(NULL,0, "SqHighest", Period1, PRICE_HIGH)
#define BOLLINGERBANDS_1 1     //iBands(NULL,0, BollingerBandsPrd1, 0, 5.6, PRICE_CLOSE)
#define PIVOTS_1 2     //iCustom(NULL,0, "SqPivots", 18, 50)
#define HIGHESTINRANGE_1 3     //iCustom(NULL,0, "SqHighestInRange", "22:00", "18:00")
...
string sqStrategyName = "Strategy 0.2497";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = ((sqIsRising(HIGHEST_1, 3, true, 1 + 1, 0))
      &&   (NormalizeDouble((double) sqGetIndicatorValue(BOLLINGERBANDS_1, 0 + 1, 1), 6) >= NormalizeDouble((double) sqGetIndicatorValue(PIVOTS_1, 6, 1), 6)));
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice(sqGetIndicatorValue(HIGHESTINRANGE_1, 0, 1), "Current");
...
bool initIndicators(){
   ...
   indicatorHandles[HIGHEST_1] = iCustom(NULL,0, "SqHighest", Period1, PRICE_HIGH);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[BOLLINGERBANDS_1] = iBands(NULL,0, BollingerBandsPrd1, 0, 5.6, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[PIVOTS_1] = iCustom(NULL,0, "SqPivots", 18, 50);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[HIGHESTINRANGE_1] = iCustom(NULL,0, "SqHighestInRange", "22:00", "18:00");
