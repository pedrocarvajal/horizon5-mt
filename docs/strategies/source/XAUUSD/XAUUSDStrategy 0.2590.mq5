...
input string CustomComment = "XAUUSDStrategy_0_2590";
...
input int ATRPeriod1 = 48;        //ATRPeriod1
input double ProfitTargetCoef1 = 3.05;        //ProfitTargetCoef1
...
#define PIVOTS_1 1     //iCustom(NULL,0, "SqPivots", 15, 57)
#define PIVOTS_2 2     //iCustom(NULL,0, "SqPivots", 9, 43)
#define BOLLINGERBANDS_1 3     //iBands(NULL,0, 10, 0, 1.9, PRICE_CLOSE)
...
string sqStrategyName = "Strategy 0.2590";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = ((NormalizeDouble((double) sqGetIndicatorValue(ATR_1, 0, 1), 6) <= NormalizeDouble((double) sqGetIndicatorValue(ATR_1, 0, 1), 6))
      &&   (NormalizeDouble((double) sqGetIndicatorValue(PIVOTS_1, 3, 1), 6) <= NormalizeDouble((double) sqGetIndicatorValue(PIVOTS_2, 2, 1), 6)));
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[PIVOTS_1] = iCustom(NULL,0, "SqPivots", 15, 57);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[PIVOTS_2] = iCustom(NULL,0, "SqPivots", 9, 43);
