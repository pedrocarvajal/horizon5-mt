...
input string CustomComment = "XAUUSDStrategy_0_1473";
...
input int ATRPeriod1 = 70;        //ATRPeriod1
input int BollingerBandsPrd1 = 13;        //BollingerBandsPrd1
input double ProfitTargetCoef1 = 3.17;        //ProfitTargetCoef1
input double StopLossCoef1 = 2.36;        //StopLossCoef1
...
#define BOLLINGERBANDS_2 2     //iBands(NULL,0, 37, 0, 6.2, PRICE_CLOSE)
#define ATR_2 3     //iCustom(NULL, 0, "SqATR", 14)
...
string sqStrategyName = "Strategy 0.1473";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = ((sqIsFalling(ATR_1, 5, false, 1 + 1, 0))
      &&   (NormalizeDouble((double) sqGetIndicatorValue(BOLLINGERBANDS_1, 0 + 1, 1), 6) <= NormalizeDouble((double) sqClose(NULL,0, 1), 6)));
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice(sqGetIndicatorValue(BOLLINGERBANDS_2, 0 + 1, 1), "Current");
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[BOLLINGERBANDS_2] = iBands(NULL,0, 37, 0, 6.2, PRICE_CLOSE);
