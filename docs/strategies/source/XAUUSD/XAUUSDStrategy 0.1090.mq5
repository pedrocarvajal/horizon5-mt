...
input string CustomComment = "XAUUSDStrategy_0_1090";
...
input double ProfitTargetCoef1 = 3.69;        //ProfitTargetCoef1
input double StopLossCoef1 = 1.57;        //StopLossCoef1
...
#define HIGHESTINRANGE_1 0     //iCustom(NULL,0, "SqHighestInRange", "6:00", "0:00")
...
string sqStrategyName = "Strategy 0.1090";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (sqIsFalling("sqClose(NULL,0, 1)", 3, false, 0 + 1, 0));
...
bool initIndicators(){
   ...
   indicatorHandles[HIGHESTINRANGE_1] = iCustom(NULL,0, "SqHighestInRange", "6:00", "0:00");
