...
input string CustomComment = "XAUUSDStrategy_0_2648";
...
input int Period1 = 58;        //Period1
input double ProfitTargetCoef1 = 3.03;        //ProfitTargetCoef1
input double StopLossCoef1 = 1.64;        //StopLossCoef1
...
#define HIGHESTINRANGE_1 2     //iCustom(NULL,0, "SqHighestInRange", "6:00", "11:00")
...
string sqStrategyName = "Strategy 0.2648";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (NormalizeDouble((double) sqGetIndicatorValue(HIGHEST_1, 0, 1), 6) >= NormalizeDouble((double) sqGetIndicatorValue(PIVOTS_1, 2, 1), 6));
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[HIGHESTINRANGE_1] = iCustom(NULL,0, "SqHighestInRange", "6:00", "11:00");
