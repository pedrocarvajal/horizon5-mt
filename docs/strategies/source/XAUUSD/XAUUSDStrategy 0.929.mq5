...
input string CustomComment = "XAUUSDStrategy_0_929";
...
input int SMAPeriod1 = 44;        //SMAPeriod1
input int SMAPeriod2 = 33;        //SMAPeriod2
...
#define HIGHEST_1 2     //iCustom(NULL,0, "SqHighest", 39, PRICE_HIGH)
...
string sqStrategyName = "Strategy 0.929";
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[HIGHEST_1] = iCustom(NULL,0, "SqHighest", 39, PRICE_HIGH);
