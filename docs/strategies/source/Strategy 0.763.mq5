...
input string CustomComment = "Strategy_0_763";
...
input int EMAPeriod1 = 37;        //EMAPeriod1
input int EMAPeriod2 = 134;        //EMAPeriod2
input int Period2 = 21;        //Period2
input int Period3 = 16;        //Period3
input int EMAPeriod3 = 183;        //EMAPeriod3
input int Period4 = 1;        //Period4
input double ProfitTargetCoef1 = 4.3;        //ProfitTargetCoef1
input double StopLossCoef1 = 3.4;        //StopLossCoef1
...
#define LOWEST_2 5     //iCustom(NULL,0, "SqLowest", Period3, PRICE_CLOSE)
#define EMA_3 6     //iMA(NULL,0, EMAPeriod3, 0, MODE_EMA, PRICE_CLOSE)
#define HIGHEST_3 7     //iCustom(NULL,0, "SqHighest", Period4, PRICE_CLOSE)
#define ATR_1 8     //iCustom(NULL, 0, "SqATR", 14)
...
string sqStrategyName = "Strategy 0.763";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = indyCrossesBelow(LOWEST_1, EMA_1, 1, 1, 0, 0);

     ShortEntrySignal = (((NormalizeDouble((double) sqGetIndicatorValue(EMA_2, 0, 1), 6) > NormalizeDouble((double) sqGetIndicatorValue(HIGHEST_1, 0, 1), 6))
      &&   indyCrossesAbove(HIGHEST_2, LOWEST_2, 1, 1, 0, 0))
      &&   indyCrossesAbove(EMA_3, HIGHEST_3, 1, 1, 0, 0));
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[LOWEST_2] = iCustom(NULL,0, "SqLowest", Period3, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[EMA_3] = iMA(NULL,0, EMAPeriod3, 0, MODE_EMA, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[HIGHEST_3] = iCustom(NULL,0, "SqHighest", Period4, PRICE_CLOSE);
