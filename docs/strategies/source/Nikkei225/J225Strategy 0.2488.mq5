...
input string CustomComment = "J225Strategy_0_2488";
...
input int Period1 = 89;        //Period1
input double ProfitTargetCoef1 = 2.19;        //ProfitTargetCoef1
input double StopLossCoef1 = 1.96;        //StopLossCoef1
...
#define PIVOTS_1 0     //iCustom(NULL,0, "SqPivots", 0, 15)
#define LOWEST_1 1     //iCustom(NULL,0, "SqLowest", Period1, PRICE_LOW)
#define HIGHEST_1 2     //iCustom(NULL,0, "SqHighest", 85, PRICE_HIGH)
...
string sqStrategyName = "Strategy 0.2488";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = indyCrossesAbove(PIVOTS_1, LOWEST_1, 1, 1, 6, 0);
...
bool initIndicators(){
   ...
   indicatorHandles[PIVOTS_1] = iCustom(NULL,0, "SqPivots", 0, 15);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[LOWEST_1] = iCustom(NULL,0, "SqLowest", Period1, PRICE_LOW);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[HIGHEST_1] = iCustom(NULL,0, "SqHighest", 85, PRICE_HIGH);
