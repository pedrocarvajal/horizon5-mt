...
input string CustomComment = "J225Strategy_0_2179";
...
input int EMAPeriod1 = 16;        //EMAPeriod1
input double ProfitTargetCoef1 = 2.89;        //ProfitTargetCoef1
input double StopLossCoef1 = 1.68;        //StopLossCoef1
...
#define BOLLINGERBANDS_1 0     //iBands(NULL,0, BollingerBandsPrd1, 0, 1.9, PRICE_CLOSE)
#define EMA_1 1     //iMA(NULL,0, EMAPeriod1, 0, MODE_EMA, PRICE_CLOSE)
#define HIGHEST_1 2     //iCustom(NULL,0, "SqHighest", 20, PRICE_HIGH)
...
string sqStrategyName = "Strategy 0.2179";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = ((sqIsRising(BOLLINGERBANDS_1, 10, false, 1 + 1, 0 + 1))
      &&   (NormalizeDouble((double) sqClose(NULL,0, 1), 6) >= NormalizeDouble((double) sqGetIndicatorValue(EMA_1, 0, 1), 6)));
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[HIGHEST_1] = iCustom(NULL,0, "SqHighest", 20, PRICE_HIGH);
