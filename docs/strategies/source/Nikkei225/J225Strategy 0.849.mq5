...
input string CustomComment = "J225Strategy_0_849";
...
input double ProfitTargetCoef1 = 1.39;        //ProfitTargetCoef1
...
string sqStrategyName = "Strategy 0.849";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = ((sqIsRising(EMA_1, 6, true, 1 + 1, 0))
      &&   (NormalizeDouble((double) sqGetIndicatorValue(PIVOTS_1, 1, 1), 6) <= NormalizeDouble((double) sqGetIndicatorValue(EMA_1, 0, 1), 6)));
