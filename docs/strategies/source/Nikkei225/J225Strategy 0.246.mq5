...
input string CustomComment = "J225Strategy_0_246";
...
input int BollingerBandsPrd1 = 95;        //BollingerBandsPrd1
input int BollingerBandsPrd2 = 22;        //BollingerBandsPrd2
input double ProfitTargetCoef1 = 2.59;        //ProfitTargetCoef1
input double StopLossCoef1 = 1.87;        //StopLossCoef1
...
#define BOLLINGERBANDS_1 0     //iBands(NULL,0, BollingerBandsPrd1, 0, 1.1, PRICE_CLOSE)
#define BOLLINGERBANDS_2 1     //iBands(NULL,0, BollingerBandsPrd2, 0, 1.9, PRICE_CLOSE)
#define HIGHEST_1 2     //iCustom(NULL,0, "SqHighest", 78, PRICE_HIGH)
#define ATR_1 3     //iCustom(NULL, 0, "SqATR", 14)
...
string sqStrategyName = "Strategy 0.246";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = ((sqIsFalling(BOLLINGERBANDS_1, 4, true, 1 + 1, 0 + 1))
      &&   (sqIsRising(BOLLINGERBANDS_2, 5, true, 1 + 1, 0 + 1)));
...
//------------------------
...
)
   {
      ...
      if(_ticket > 0) {
         ...
         sqSetOrderExpiration(_ticket, 23);
...
bool initIndicators(){
   ...
   indicatorHandles[BOLLINGERBANDS_1] = iBands(NULL,0, BollingerBandsPrd1, 0, 1.1, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[BOLLINGERBANDS_2] = iBands(NULL,0, BollingerBandsPrd2, 0, 1.9, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[HIGHEST_1] = iCustom(NULL,0, "SqHighest", 78, PRICE_HIGH);
