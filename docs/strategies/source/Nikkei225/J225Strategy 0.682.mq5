...
//|    Generated at 03/15/2026 07:42
//| 
//|    Backtested on J225_dukascopy / H1, 2020.01.01 - 2025.12.31 
//+------------------------------------------------------------------+
...
input string CustomComment = "J225Strategy_0_682";
...
input int EMAPeriod1 = 4;        //EMAPeriod1
input int Period1 = 33;        //Period1
input int SMAPeriod1 = 53;        //SMAPeriod1
input int SMAPeriod2 = 51;        //SMAPeriod2
input double ProfitTargetCoef1 = 2.56;        //ProfitTargetCoef1
input double StopLossCoef1 = 1.52;        //StopLossCoef1
...
#define HIGHEST_1 1     //iCustom(NULL,0, "SqHighest", Period1, PRICE_HIGH)
#define SMA_1 2     //iMA(NULL,0, SMAPeriod1, 0, MODE_SMA, PRICE_CLOSE)
#define SMA_2 3     //iMA(NULL,0, SMAPeriod2, 0, MODE_SMA, PRICE_CLOSE)
#define HIGHEST_2 4     //iCustom(NULL,0, "SqHighest", 65, PRICE_HIGH)
...
string sqStrategyName = "Strategy 0.682";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = ((NormalizeDouble((double) sqGetIndicatorValue(EMA_1, 0, 1), 6) <= NormalizeDouble((double) sqGetIndicatorValue(HIGHEST_1, 0, 1), 6))
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[HIGHEST_2] = iCustom(NULL,0, "SqHighest", 65, PRICE_HIGH);
