...
input string CustomComment = "J225Strategy_0_1695";
...
input int EMAPeriod1 = 58;        //EMAPeriod1
input int BollingerBandsPrd1 = 22;        //BollingerBandsPrd1
input double ProfitTargetCoef1 = 1.51;        //ProfitTargetCoef1
input double StopLossCoef1 = 1.23;        //StopLossCoef1
...
#define LOWEST_1 0     //iCustom(NULL,0, "SqLowest", Period1, PRICE_LOW)
#define EMA_1 1     //iMA(NULL,0, EMAPeriod1, 0, MODE_EMA, PRICE_CLOSE)
#define BOLLINGERBANDS_1 2     //iBands(NULL,0, BollingerBandsPrd1, 0, 2.0, PRICE_CLOSE)
#define HIGHEST_1 3     //iCustom(NULL,0, "SqHighest", 32, PRICE_HIGH)
...
string sqStrategyName = "Strategy 0.1695";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = ((NormalizeDouble((double) sqGetIndicatorValue(LOWEST_1, 0, 1), 6) <= NormalizeDouble((double) sqGetIndicatorValue(EMA_1, 0, 1), 6))
      &&   (sqIsRising(BOLLINGERBANDS_1, 12, false, 1 + 1, 0 + 1)));
...
//------------------------
...
)
   {
      ...
      if(_ticket > 0) {
         ...
         sqSetOrderExpiration(_ticket, 1);
...
bool initIndicators(){
   ...
   indicatorHandles[LOWEST_1] = iCustom(NULL,0, "SqLowest", Period1, PRICE_LOW);
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[HIGHEST_1] = iCustom(NULL,0, "SqHighest", 32, PRICE_HIGH);
