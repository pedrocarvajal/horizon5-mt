...
input string CustomComment = "J225Strategy_0_1088";
...
input int SMAPeriod1 = 87;        //SMAPeriod1
input double ProfitTargetCoef1 = 2.52;        //ProfitTargetCoef1
...
#define HIGHEST_1 1     //iCustom(NULL,0, "SqHighest", 68, PRICE_HIGH)
...
string sqStrategyName = "Strategy 0.1088";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (sqIsFalling(SMA_1, 5, false, 1 + 1, 0));
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[HIGHEST_1] = iCustom(NULL,0, "SqHighest", 68, PRICE_HIGH);
