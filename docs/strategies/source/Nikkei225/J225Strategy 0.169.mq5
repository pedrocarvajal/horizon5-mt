...
input string CustomComment = "J225Strategy_0_169";
...
input int BollingerBandsPrd1 = 56;        //BollingerBandsPrd1
input double ProfitTargetCoef1 = 2.51;        //ProfitTargetCoef1
input double StopLossCoef1 = 1.19;        //StopLossCoef1
...
#define BOLLINGERBANDS_1 0     //iBands(NULL,0, BollingerBandsPrd1, 0, 2.1, PRICE_CLOSE)
#define HIGHEST_1 1     //iCustom(NULL,0, "SqHighest", 53, PRICE_HIGH)
...
string sqStrategyName = "Strategy 0.169";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (NormalizeDouble((double) sqClose(NULL,0, 1), 6) >= NormalizeDouble((double) sqGetIndicatorValue(BOLLINGERBANDS_1, 0 + 1, 1), 6));
...
//------------------------
...
)
   {
      ...
      if(_ticket > 0) {
         ...
         sqSetOrderExpiration(_ticket, 12);
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[HIGHEST_1] = iCustom(NULL,0, "SqHighest", 53, PRICE_HIGH);
