...
input string CustomComment = "J225Strategy_0_900";
...
input int Period1 = 4;        //Period1
input int SMAPeriod1 = 27;        //SMAPeriod1
input double ProfitTargetCoef1 = 2.42;        //ProfitTargetCoef1
input double StopLossCoef1 = 1.46;        //StopLossCoef1
...
#define BOLLINGERBANDS_1 2     //iBands(NULL,0, 50, 0, 2.1, PRICE_CLOSE)
...
string sqStrategyName = "Strategy 0.900";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = indyCrossesAbove(HIGHEST_1, SMA_1, 1, 1, 0, 0);
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[BOLLINGERBANDS_1] = iBands(NULL,0, 50, 0, 2.1, PRICE_CLOSE);
