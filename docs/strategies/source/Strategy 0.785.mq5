...
input string CustomComment = "Strategy_0_785";
...
input int ATRPeriod1 = 188;        //ATRPeriod1
...
input double ProfitTargetCoef2 = 4.4;        //ProfitTargetCoef2
...
string sqStrategyName = "Strategy 0.785";
...
if (_sqIsBarOpen == true) {
     ...
     ShortEntrySignal = indyCrossesAbove("sqClose(NULL,0, 1)", LOWEST_1, 0, 1, 0, 0);
