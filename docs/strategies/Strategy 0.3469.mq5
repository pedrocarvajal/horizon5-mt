...
input string CustomComment = "Strategy_0_3469";
...
input int ATRPeriod1 = 191;        //ATRPeriod1
input int ATRPeriod2 = 26;        //ATRPeriod2
input int EMAPeriod2 = 14;        //EMAPeriod2
input int Period1 = 11;        //Period1
input int EMAPeriod3 = 159;        //EMAPeriod3
...
string sqStrategyName = "Strategy 0.3469";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (sqIsFalling(EMA_1, 2, true, 1 + 1, 0));
     ...
     ShortEntrySignal = (((NormalizeDouble((double) sqGetIndicatorValue(ATR_1, 0, 1), 6) < NormalizeDouble((double) sqGetIndicatorValue(ATR_2, 0, 1), 6))
      &&   indyCrossesAbove(EMA_2, HIGHEST_1, 1, 1, 0, 0))
