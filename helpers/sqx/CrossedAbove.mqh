...
bool CrossedAbove(double previousValue1, double currentValue1, double previousValue2, double currentValue2) {
...
bool CrossedBelow(double previousValue1, double currentValue1, double previousValue2, double currentValue2) {
